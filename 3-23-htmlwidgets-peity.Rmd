...
```{block, type='rmdnote'}
The order of the dependencies matters, peity.js depends on jQuery hence the latter comes first in the `.yaml`.
```
...
```{r peity-divs, echo=FALSE, fig.cap='Peity output with DIV'}
...
```{r peity-spans, echo=FALSE, fig.cap='Peity output with SPAN'}
