...
Peity.js depends on jQuery, hence the latter is imported first, the data for the chart is placed in a `<span>`, and the `peity` method is used on the element containing the data.
...
```r
typed <- function(message, loop = FALSE, 
