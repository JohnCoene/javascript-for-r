...
```{r candidate-plotly, echo=FALSE, fig.cap='Plotly example'}
...
```{r candidate-highcharts, echo=FALSE, fig.cap='Highcharts example'}
...
```{r candidate-chartjs, echo=FALSE, fig.cap='Chart.js example'}
...
```{r widget-inner-diagram, echo=FALSE, fig.cap='htmlwidgets inner-workings visualised'}
d <- DiagrammeR::grViz("
digraph {
  graph [rankdir = LR]
