...
Nonetheless, it is doable with htmlwdigets' serialiser (an only that one). The function `htmlwidgets::JS` can be used to mark a character vector so that it will be treated as JavaScript code when evaluated in the browser.
