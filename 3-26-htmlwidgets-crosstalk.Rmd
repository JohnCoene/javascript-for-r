...
```{r, echo=FALSE, fig.cap='Crosstalk example'}
...
```{r, echo=FALSE, fig.cap='Shiny with crosstalk'}
...
```{r, echo=FALSE, fig.cap='Gio with DT using crosstalk'}
...
```{r, echo=FALSE, fig.cap='Gio and plotly using crosstalk and groups'}
