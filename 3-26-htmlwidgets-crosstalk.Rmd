...
```{r crosstalk-1, echo=FALSE, fig.cap='Crosstalk example'}
...
```{r crosstalk-shiny, echo=FALSE, fig.cap='Shiny with crosstalk'}
...
```{r crosstalk-diagram, echo=FALSE, fig.cap='Crosstalk visualised'}
d <- DiagrammeR::grViz("
digraph G {
...
```{r crosstalk-groups-diagram, echo=FALSE, fig.cap='crosstalk groups visualised'}
d <- DiagrammeR::grViz("
digraph G {
...
```{r crosstalk-gio-1, echo=FALSE, fig.cap='Gio with DT using crosstalk'}
...
```{r crosstalk-gio-diagram, echo=FALSE, fig.cap='Crosstalk with gio'}
d <- DiagrammeR::grViz("
digraph {
...
```{r crosstalk-gio-2, echo=FALSE, fig.cap='Gio and plotly using crosstalk and groups'}
