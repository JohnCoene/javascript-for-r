...
The `origData` method is needed to extract the data from the shared dataset. This is of course necessary as the `gio` function still needs to obtain and serialise data to display on the globe.
