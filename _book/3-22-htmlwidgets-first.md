...
This effectively imports the `htmlwidgets.js` library and the `play.js` file and was the visualisation depending on external libraries they would appear alongside those. 
