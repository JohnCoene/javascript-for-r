...
\caption{First widget}(\#fig:unnamed-chunk-2)
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{3-22-htmlwidgets-first_files/figure-latex/unnamed-chunk-3-1} 
...
\caption{Console tab output}(\#fig:unnamed-chunk-4)
\end{figure}
...
\caption{Console tab output element}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{First widget output}(\#fig:unnamed-chunk-7)
\end{figure}
...
\caption{First widget using shiny tags}(\#fig:unnamed-chunk-9)
\end{figure}
