...
<p class="caption">(\#fig:unnamed-chunk-2)First widget</p>
</div>
...
This is so htmlwidgets can internally match the output of `createWidget` to its JavaScript function. At this stage it is probably good to take a look at the diagram of what is happening.

<!--html_preserve--><div id="htmlwidget-21315b483ab992f518a5" style="width:100%;height:250px;" class="grViz html-widget"></div>
<script type="application/json" data-for="htmlwidget-21315b483ab992f518a5">{"x":{"diagram":"\ndigraph {\n  graph [rankdir = LR]\n\n  subgraph cluster_1 {\n    node [shape=box]\n    func [label=\"play(id)\"]\n    label = \"R\"\n    color=royalBlue\n  }\n\n  subgraph cluster_0 {\n    node [shape=box]\n    output [label=\"<div class=play id=id>\"]\n    json [label=\"<script data-for=id>\"]\n    js [label=\"JavaScript\"]\n    deps [label=\"dependencies\"]\n    label=\"HTML\"\n    color=gold\n  }\n\n  func -> output [label=\"id and class\"]\n  func -> json [label = \"id\"]\n  json -> js [label=\"import\"]\n  js -> output[label=\"Generate viz\"] \n  deps -> js [label=\"use\"]\n\n}\n","config":{"engine":"dot","options":null}},"evals":[],"jsHooks":[]}</script><!--/html_preserve-->
...
<div class="figure" style="text-align: center">
<img src="images/playground-console-x.png" alt="Console tab output" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-4)Console tab output</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="images/playground-console-el.png" alt="Console tab output element" width="100%" />
<p class="caption">(\#fig:unnamed-chunk-6)Console tab output element</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-7)First widget output</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-9)First widget using shiny tags</p>
</div>
