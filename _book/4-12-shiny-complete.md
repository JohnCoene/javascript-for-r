...
\caption{Shiny app skeleton}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{Results logged to the console}(\#fig:unnamed-chunk-5)
\end{figure}
...
\caption{Classifier basic output}(\#fig:unnamed-chunk-6)
\end{figure}
...
\caption{Classifier table output}(\#fig:unnamed-chunk-8)
\end{figure}
