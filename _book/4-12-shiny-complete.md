...
<p class="caption">(\#fig:unnamed-chunk-3)Shiny app skeleton</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-5)Results logged to the console</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-6)Classifier basic output</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-8)Classifier table output</p>
</div>
