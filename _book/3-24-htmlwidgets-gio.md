...
<p class="caption">(\#fig:unnamed-chunk-1)Gio.js example</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-2)Gio output without data</p>
</div>
...
JavaScript can be used to transform the data, thereby leaving the serialiser as-is only to reshape it in the client. The HTMLwidget JavaScript library (already imported by default) exports an object which provides a method, `dataframeToD3`, to transform the data from long to wide. 
...
<p class="caption">(\#fig:unnamed-chunk-6)Gio output with correct serialisation</p>
</div>
...
<p class="caption">(\#fig:unnamed-chunk-7)Gio with a new theme</p>
</div>
