...
\caption{Package creation wizard}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{console.table output}(\#fig:unnamed-chunk-9)
\end{figure}
...
\caption{Trying JavaScript}(\#fig:unnamed-chunk-13)
\end{figure}
...
\caption{Google Chrome Devtools}(\#fig:unnamed-chunk-15)
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{1-02-basics_files/figure-latex/unnamed-chunk-19-1} 
