...
\caption{A basic jBox notice}(\#fig:unnamed-chunk-3)
\end{figure}
...
\caption{[A notice triggered by the server}(\#fig:unnamed-chunk-4)
\end{figure}
...
\begin{center}\includegraphics[width=1\linewidth]{4-11-shiny-first-look_files/figure-latex/unnamed-chunk-5-1} 
...
\caption{Customised jBox notice}(\#fig:unnamed-chunk-7)
\end{figure}
...
\caption{jBox final application}(\#fig:unnamed-chunk-10)
\end{figure}
