...
\begin{verbatim}
## [1] "Sat Jun 06 2020 00:02:28 GMT+0200 (CEST)"
\end{verbatim}
...
\hypertarget{a-two-way-street}{%
\chapter{A Two-way Street}\label{a-two-way-street}}
...
\hypertarget{part-html-widgets-visualisation}{%
\part{HTML Widgets Visualisation}\label{part-html-widgets-visualisation}}
...
Let's add the option to style the globe, gio.js provides \href{https://giojs.org/html/docs/colorStyle.html}{themes} but they are currently not applicable from R. As a matter of fact, gio.js provides dozens of customisation options that should be integrated into the package. These probably should be split across functions, just like they are in gio.js, rather than all grouped into a single function. This may first appear as difficult to implement, how, when, how would one use another function given the function \texttt{gio} generates the visualisation? The \texttt{gio} function creates everything needed for the visualisation to be generated but does not actually render anything, it returns an object of class ``htmlwidget'' which itself renders the visualisation on print (literally \texttt{htmlwidget.print} method).
...
Therefore, one can use functions on the object returned by \texttt{gio} to further modify that object.

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{str}\NormalTok{(arcs)}

\CommentTok{\#\# List of 8}
\CommentTok{\#\#  $ x            :List of 1}
\CommentTok{\#\#   ..$ data:\textquotesingle{}data.frame\textquotesingle{}:        2 obs. of  3 variables:}
\CommentTok{\#\#   .. ..$ e: chr [1:2] "CN" "CN"}
\CommentTok{\#\#   .. ..$ i: chr [1:2] "US" "RU"}
\CommentTok{\#\#   .. ..$ v: int [1:2] 3300000 10000}
\CommentTok{\#\#   ..{-} attr(*, "TOJSON\_ARGS")=List of 1}
\CommentTok{\#\#   .. ..$ dataframe: chr "rows"}
\CommentTok{\#\#  $ width        : NULL}
\CommentTok{\#\#  $ height       : NULL}
\CommentTok{\#\#  $ sizingPolicy :List of 6}
\CommentTok{\#\#   ..$ defaultWidth : NULL}
\CommentTok{\#\#   ..$ defaultHeight: NULL}
\CommentTok{\#\#   ..$ padding      : NULL}
\CommentTok{\#\#   ..$ viewer       :List of 6}
\CommentTok{\#\#   .. ..$ defaultWidth : NULL}
\CommentTok{\#\#   .. ..$ defaultHeight: NULL}
\CommentTok{\#\#   .. ..$ padding      : NULL}
\CommentTok{\#\#   .. ..$ fill         : logi TRUE}
\CommentTok{\#\#   .. ..$ suppress     : logi FALSE}
\CommentTok{\#\#   .. ..$ paneHeight   : NULL}
\CommentTok{\#\#   ..$ browser      :List of 5}
\CommentTok{\#\#   .. ..$ defaultWidth : NULL}
\CommentTok{\#\#   .. ..$ defaultHeight: NULL}
\CommentTok{\#\#   .. ..$ padding      : NULL}
\CommentTok{\#\#   .. ..$ fill         : logi FALSE}
\CommentTok{\#\#   .. ..$ external     : logi FALSE}
\CommentTok{\#\#   ..$ knitr        :List of 3}
\CommentTok{\#\#   .. ..$ defaultWidth : NULL}
\CommentTok{\#\#   .. ..$ defaultHeight: NULL}
\CommentTok{\#\#   .. ..$ figure       : logi TRUE}
\CommentTok{\#\#  $ dependencies : NULL}
\CommentTok{\#\#  $ elementId    : NULL}
\CommentTok{\#\#  $ preRenderHook: NULL}
\CommentTok{\#\#  $ jsHooks      : list()}
\CommentTok{\#\#  {-} attr(*, "class")= chr [1:2] "gio" "htmlwidget"}
\CommentTok{\#\#  {-} attr(*, "package")= chr "gio"}
\end{Highlighting}
\end{Shaded}

\hypertarget{javascript-functions}{%
\section*{JavaScript Functions}\label{javascript-functions}}
