...
\item
  The book opens with an introduction to illustrate its premise better, it provides rationales for using JavaScript in conjunction with R which it supports with existing R packages that make use of JavaScript and are available on CRAN. Then it briefly describes concepts essential to understanding the rest of the book to ensure the reader can follow along. Finally, this part closes by listing the various methods with which one might make JavaScript work with R.
\item
...
\KeywordTok{lawn\_count}\NormalTok{(}
\NormalTok{  lawn\_data}\OperatorTok{$}\NormalTok{polygons\_count, }
\NormalTok{  lawn\_data}\OperatorTok{$}\NormalTok{points\_count, }
  \StringTok{"population"}
\NormalTok{)}
\CommentTok{\#\textgreater{} \textless{}FeatureCollection\textgreater{}}
\CommentTok{\#\textgreater{}   Bounding box: {-}112.1 46.6 {-}112.0 46.6}
\CommentTok{\#\textgreater{}   No. features: 2}
\CommentTok{\#\textgreater{}   No. points: 20}
\CommentTok{\#\textgreater{}   Properties: }
\CommentTok{\#\textgreater{}     values count}
\CommentTok{\#\textgreater{} 1 200, 600     2}
...
\CommentTok{\#\textgreater{}     "c": ["A", "B"]}
\CommentTok{\#\textgreater{}   \},}
\CommentTok{\#\textgreater{}   "d": [1, 2, 3, 4, 5]}
\CommentTok{\#\textgreater{} \}}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [}
\CommentTok{\#\textgreater{}   \{}
\CommentTok{\#\textgreater{}     "speed": 4,}
\CommentTok{\#\textgreater{}     "dist": 2}
\CommentTok{\#\textgreater{}   \},}
\CommentTok{\#\textgreater{}   \{}
\CommentTok{\#\textgreater{}     "speed": 4,}
\CommentTok{\#\textgreater{}     "dist": 10}
\CommentTok{\#\textgreater{}   \}}
\CommentTok{\#\textgreater{} ]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{\{}
\NormalTok{    value \textless{}{-}}\StringTok{ }\KeywordTok{restoreInput}\NormalTok{(}\DataTypeTok{id =}\NormalTok{ inputId, }\DataTypeTok{default =} \OtherTok{NULL}\NormalTok{)}
\NormalTok{    tags}\OperatorTok{$}\KeywordTok{button}\NormalTok{(}
      ...
      \StringTok{\textasciigrave{}}\DataTypeTok{data{-}val}\StringTok{\textasciigrave{}}\NormalTok{ =}\StringTok{ }\NormalTok{value, }\KeywordTok{list}\NormalTok{(}\KeywordTok{validateIcon}\NormalTok{(icon), label), }
\NormalTok{      ...}
\NormalTok{    )}
\NormalTok{\}}
\end{Highlighting}
...
\StringTok{    dist/jquery.min.js"}\KeywordTok{\textgreater{}}
\KeywordTok{\textless{}/script\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  output}\OperatorTok{$}\NormalTok{myTable \textless{}{-}}\StringTok{ }\KeywordTok{renderDT}\NormalTok{(\{}
    \KeywordTok{datatable}\NormalTok{(mtcars)}
\NormalTok{  \})}

\NormalTok{  output}\OperatorTok{$}\NormalTok{selected \textless{}{-}}\StringTok{ }\KeywordTok{renderPrint}\NormalTok{(\{}
\NormalTok{    input}\OperatorTok{$}\NormalTok{myTable\_rows\_selected}
\NormalTok{  \})}
...
\NormalTok{sd \textless{}{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(iris[, }\KeywordTok{c}\NormalTok{(}\StringTok{"Sepal.Length"}\NormalTok{, }\StringTok{"Sepal.Width"}\NormalTok{)])}
...
\CommentTok{\#\textgreater{} [1] "shiny.tag"}

\CommentTok{\# returns string}
\KeywordTok{as.character}\NormalTok{(html)}
\CommentTok{\#\textgreater{} [1] "\textless{}h1\textgreater{}HTML tag\textless{}/h1\textgreater{}"}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{\textless{}head\textgreater{}}
  ...
  \KeywordTok{\textless{}script}\OtherTok{ src=}\StringTok{"jquery{-}3.5.1.min.js"}\KeywordTok{\textgreater{}\textless{}/script\textgreater{}}
  \KeywordTok{\textless{}script}\OtherTok{ src=}\StringTok{"jquery.peity.min.js"}\KeywordTok{\textgreater{}\textless{}/script\textgreater{}}
\KeywordTok{\textless{}/head\textgreater{}}

\KeywordTok{\textless{}body\textgreater{}}
  \CommentTok{\textless{}!{-}{-} div to hold visualisation {-}{-}\textgreater{}}
  \KeywordTok{\textless{}span}\OtherTok{ id=}\StringTok{"bar"}\KeywordTok{\textgreater{}}\NormalTok{5,3,9,6,5,9,7,3,5,2}\KeywordTok{\textless{}/span\textgreater{}}

  \CommentTok{\textless{}!{-}{-} Script to create visualisation {-}{-}\textgreater{}}
  \KeywordTok{\textless{}script\textgreater{}}
\NormalTok{    $(}\StringTok{"\#bar"}\NormalTok{)}\OperatorTok{.}\FunctionTok{peity}\NormalTok{(}\StringTok{"bar"}\NormalTok{)}\OperatorTok{;}
  \KeywordTok{\textless{}/script\textgreater{}}
\KeywordTok{\textless{}/body\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{$(el)}\OperatorTok{.}\FunctionTok{peity}\NormalTok{(}\StringTok{"bar"}\OperatorTok{,}\NormalTok{ \{}
  \DataTypeTok{fill}\OperatorTok{:}\NormalTok{ [}\StringTok{"red"}\OperatorTok{,} \StringTok{"green"}\OperatorTok{,} \StringTok{"blue"}\NormalTok{]}
\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{$(el)}\OperatorTok{.}\FunctionTok{peity}\NormalTok{(x}\OperatorTok{.}\AttributeTok{type}\OperatorTok{,}\NormalTok{ \{}
  \DataTypeTok{fill}\OperatorTok{:}\NormalTok{ [}\StringTok{"red"}\OperatorTok{,} \StringTok{"green"}\OperatorTok{,} \StringTok{"blue"}\NormalTok{]}
\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{$(el)}\OperatorTok{.}\FunctionTok{peity}\NormalTok{(x}\OperatorTok{.}\AttributeTok{type}\OperatorTok{,}\NormalTok{ x}\OperatorTok{.}\AttributeTok{options}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{peity\_html \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(...)\{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myWidget\_html \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(..., class)\{}
...
\CommentTok{\#\textgreater{}    e  i       v}
\CommentTok{\#\textgreater{} 1 CN US 3300000}
\CommentTok{\#\textgreater{} 2 CN RU   10000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} \{"e":["CN","CN"],"i":["US","RU"],"v":[3300000,10000]\}}
\CommentTok{\# row{-}wise}
\NormalTok{jsonlite}\OperatorTok{::}\KeywordTok{toJSON}\NormalTok{(arcs, }\DataTypeTok{dataframe =} \StringTok{"rows"}\NormalTok{)}
\CommentTok{\#\textgreater{} [\{"e":"CN","i":"US","v":3300000\},\{"e":"CN","i":"RU","v":10000\}]}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] "var x = 3;"}
\CommentTok{\#\textgreater{} attr(,"class")}
\CommentTok{\#\textgreater{} [1] "JS\_EVAL"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sd\_cars \textless{}{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(cars[}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{,])}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sd\_cars}\OperatorTok{$}\KeywordTok{key}\NormalTok{()}
...
\NormalTok{df \textless{}{-}}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{runif}\NormalTok{(}\DecValTok{5}\NormalTok{))}
\NormalTok{sd \textless{}{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(df, }\DataTypeTok{key =}\NormalTok{ letters[}\DecValTok{1}\OperatorTok{:}\DecValTok{5}\NormalTok{])}
...
\CommentTok{\#\textgreater{} [1] "SharedData" "R6"}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] "SharedData297ec031"}

\CommentTok{\# keys}
\NormalTok{shared\_arcs}\OperatorTok{$}\KeywordTok{key}\NormalTok{()}
\CommentTok{\#\textgreater{} [1] "US" "RU"}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Wrap data frame in SharedData}
\NormalTok{edges\_sd \textless{}{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(}
...
\KeywordTok{\textless{}head\textgreater{}}
\KeywordTok{\textless{}script} 
\OtherTok{  src=}\StringTok{"https://code.jquery.com/jquery{-}3.5.1.min.js"}\KeywordTok{\textgreater{}}
  \KeywordTok{\textless{}/script\textgreater{}}
\KeywordTok{\textless{}script} 
\OtherTok{  src=}\StringTok{"https://cdn.jsdelivr.net/gh/StephanWagner/jBox@v1.2.0/}
\StringTok{    dist/jBox.all.min.js"}\KeywordTok{\textgreater{}}
\KeywordTok{\textless{}/script\textgreater{}}
\KeywordTok{\textless{}link} 
\OtherTok{  href=}\StringTok{"https://cdn.jsdelivr.net/gh/StephanWagner/jBox@v1.2.0/}
\StringTok{    dist/jBox.all.min.css"} 
\OtherTok{  rel=}\StringTok{"stylesheet"}\KeywordTok{\textgreater{}}
\KeywordTok{\textless{}/head\textgreater{}}

\KeywordTok{\textless{}body\textgreater{}}
  \CommentTok{\textless{}!{-}{-} Script to show a notification {-}{-}\textgreater{}}
  \KeywordTok{\textless{}script\textgreater{}}
...
\StringTok{    type = \textquotesingle{}send{-}notice\textquotesingle{}, function(message) \{}
\StringTok{      new jBox(\textquotesingle{}Notice\textquotesingle{}, \{}
...
\CommentTok{\#\textgreater{} \{}
\CommentTok{\#\textgreater{}   "content": "Hurray! A notice!",}
\CommentTok{\#\textgreater{}   "color": "red"}
\CommentTok{\#\textgreater{} \}}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} "function(x)\{x + 1\}"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{message}\OperatorTok{$}\NormalTok{onClose \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(msg)\{}
  \KeywordTok{print}\NormalTok{(msg)}
\NormalTok{\}}
\NormalTok{message}\OperatorTok{$}\KeywordTok{onClose}\NormalTok{(}\StringTok{"Closing!"}\NormalTok{)}
\CommentTok{\#\textgreater{} [1] "Closing!"}
\end{Highlighting}
\end{Shaded}
...
\StringTok{    // append callback}
\StringTok{    message.onClose = function()\{}
\StringTok{      Shiny.setInputValue(\textquotesingle{}notice\_close\textquotesingle{}, true);}
\StringTok{    \}}
\StringTok{    new jBox(\textquotesingle{}Notice\textquotesingle{}, message);}
\StringTok{\});"}\NormalTok{)}
\end{Highlighting}
...
\StringTok{        \textquotesingle{}notice\_close\textquotesingle{}, true, \{priority: \textquotesingle{}event\textquotesingle{}\}}
\StringTok{      );}
\StringTok{    \}}
\StringTok{    new jBox(\textquotesingle{}Notice\textquotesingle{}, message);}
\StringTok{\});"}\NormalTok{)}
...
\NormalTok{  \})}
  ...
  \CommentTok{\# print the output of the notice\_close event (when fired)}
  \KeywordTok{observeEvent}\NormalTok{(input}\OperatorTok{$}\NormalTok{notice\_close, \{}
    \KeywordTok{print}\NormalTok{(input}\OperatorTok{$}\NormalTok{notice\_close)}
\NormalTok{  \})}
\NormalTok{\}}
...
\NormalTok{classifier}\OperatorTok{.}\FunctionTok{classify}\NormalTok{(}
  \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(}\StringTok{\textquotesingle{}image\textquotesingle{}}\NormalTok{)}\OperatorTok{,}\NormalTok{ (err}\OperatorTok{,}\NormalTok{ results) }\KeywordTok{=\textgreater{}}\NormalTok{ \{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dependency\_ml5 \textless{}{-}}\StringTok{ }\NormalTok{htmltools}\OperatorTok{::}\KeywordTok{htmlDependency}\NormalTok{(}
...
\NormalTok{  output}\OperatorTok{$}\NormalTok{birdDisplay \textless{}{-}}\StringTok{ }\KeywordTok{renderUI}\NormalTok{(\{}
\NormalTok{    path \textless{}{-}}\StringTok{ }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"assets/\%s.jpg"}\NormalTok{, input}\OperatorTok{$}\NormalTok{selectedBird)}
...
\NormalTok{  classifier}\OperatorTok{.}\FunctionTok{classify}\NormalTok{(}
    \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(}\StringTok{"bird"}\NormalTok{)}\OperatorTok{,}\NormalTok{ (err}\OperatorTok{,}\NormalTok{ results) }\KeywordTok{=\textgreater{}}\NormalTok{ \{}
      \BuiltInTok{console}\OperatorTok{.}\FunctionTok{log}\NormalTok{(results)}
\NormalTok{    \}}
\NormalTok{  )}\OperatorTok{;}
\NormalTok{\})}\OperatorTok{;}
\end{Highlighting}
...
\NormalTok{  classifier}\OperatorTok{.}\FunctionTok{classify}\NormalTok{(}
    \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(}\StringTok{"bird"}\NormalTok{)}\OperatorTok{,}\NormalTok{ (err}\OperatorTok{,}\NormalTok{ results) }\KeywordTok{=\textgreater{}}\NormalTok{ \{}
\NormalTok{      Shiny}\OperatorTok{.}\FunctionTok{setInputValue}\NormalTok{(}\StringTok{"classification"}\OperatorTok{,}\NormalTok{ results)}
\NormalTok{    \}}
\NormalTok{  )}\OperatorTok{;}
\NormalTok{\})}\OperatorTok{;}
\end{Highlighting}
...
\NormalTok{process\_results \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(data, ...)\{}
...
\NormalTok{  classifier}\OperatorTok{.}\FunctionTok{classify}\NormalTok{(}
    \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(}\StringTok{"bird"}\NormalTok{)}\OperatorTok{,}\NormalTok{ (err}\OperatorTok{,}\NormalTok{ results) }\KeywordTok{=\textgreater{}}\NormalTok{ \{}
\NormalTok{      Shiny}\OperatorTok{.}\FunctionTok{setInputValue}\NormalTok{(}\StringTok{"classification:ml5.class"}\OperatorTok{,}\NormalTok{ results)}\OperatorTok{;}
\NormalTok{    \}}
\NormalTok{  )}\OperatorTok{;}
\NormalTok{\})}\OperatorTok{;}
\end{Highlighting}
...
\NormalTok{  output}\OperatorTok{$}\NormalTok{results \textless{}{-}}\StringTok{ }\KeywordTok{renderTable}\NormalTok{(\{}
...
\NormalTok{uri \textless{}{-}}\StringTok{ "https://unpkg.com/ml5@0.4.3/dist/ml5.min.js"}
...
\CommentTok{\# R/deps.R}
\CommentTok{\#\textquotesingle{} @export}
\NormalTok{useMl5 \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}\DataTypeTok{cdn =} \OtherTok{TRUE}\NormalTok{) \{}

  \CommentTok{\# internal classify.js file}
\NormalTok{  pkg \textless{}{-}}\StringTok{ }\NormalTok{htmltools}\OperatorTok{::}\KeywordTok{htmlDependency}\NormalTok{(}
...
\NormalTok{    ml5 \textless{}{-}}\StringTok{ }\NormalTok{htmltools}\OperatorTok{::}\KeywordTok{htmlDependency}\NormalTok{(}
      \DataTypeTok{name =} \StringTok{"ml5"}\NormalTok{,}
      \DataTypeTok{version =} \StringTok{"0.4.3"}\NormalTok{,}
      \DataTypeTok{src =} \KeywordTok{c}\NormalTok{(}\DataTypeTok{href =} \StringTok{"https://unpkg.com/ml5@0.4.3/dist/"}\NormalTok{),}
      \DataTypeTok{script =} \StringTok{"ml5.min.js"}
...
First, this will give users a much better interface where they may use whatever \texttt{id} suits them rather. Second, this will allow using the model to classify images that may be placed in different places and bear different ids.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# R/classify.R}
\CommentTok{\#\textquotesingle{} @export}
\NormalTok{classify \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(}
\NormalTok{  id, }
...
\CommentTok{\#\textgreater{} Loading ml5}

\KeywordTok{library}\NormalTok{(ml5)}

\CommentTok{\#\textgreater{} Loading ml5}
\CommentTok{\#\textgreater{} Error in shiny::registerInputHandler("ml5.class", handler) : }
\CommentTok{\#\textgreater{}   There is already an input handler for type: ml5.class}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# register with shiny}
\NormalTok{.onLoad \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(...)\{}
\NormalTok{  shiny}\OperatorTok{::}\KeywordTok{registerInputHandler}\NormalTok{(}\StringTok{"ml5.class"}\NormalTok{, handler)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  output}\OperatorTok{$}\NormalTok{results \textless{}{-}}\StringTok{ }\KeywordTok{renderDT}\NormalTok{(\{}
    \KeywordTok{datatable}\NormalTok{(input}\OperatorTok{$}\NormalTok{bird\_classification)}
\NormalTok{  \})}
...
\OtherTok{  style=}\StringTok{"width: 100\% ; height: 400px"}\KeywordTok{\textgreater{}}
\KeywordTok{\textless{}/div\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{boxxy \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(title, value, }\DataTypeTok{color =} \StringTok{"black"}\NormalTok{, }\DataTypeTok{animate =} \OtherTok{TRUE}\NormalTok{)\{}
...
\NormalTok{  func \textless{}{-}}\StringTok{ }\NormalTok{shiny}\OperatorTok{::}\KeywordTok{exprToFunction}\NormalTok{(expr, env, quoted)}
  ...
  \ControlFlowTok{function}\NormalTok{()\{}
\NormalTok{    val \textless{}{-}}\StringTok{ }\KeywordTok{func}\NormalTok{()}
...
\NormalTok{      deps \textless{}{-}}\StringTok{ }\NormalTok{htmltools}\OperatorTok{::}\KeywordTok{htmlDependency}\NormalTok{(}
...
\NormalTok{      val}\OperatorTok{$}\NormalTok{deps \textless{}{-}}\StringTok{ }\KeywordTok{list}\NormalTok{(shiny}\OperatorTok{::}\KeywordTok{createWebDependency}\NormalTok{(deps))}
\NormalTok{    \}}
...
\NormalTok{    el}\OperatorTok{.}\AttributeTok{style}\OperatorTok{.}\AttributeTok{backgroundColor} \OperatorTok{=}\NormalTok{ data}\OperatorTok{.}\AttributeTok{color}\OperatorTok{;}
    ...
    \ControlFlowTok{if}\NormalTok{(data}\OperatorTok{.}\AttributeTok{animate}\NormalTok{)\{}
      \KeywordTok{var}\NormalTok{ counter }\OperatorTok{=} \KeywordTok{new}\NormalTok{ CountUp(}
\NormalTok{        el}\OperatorTok{.}\AttributeTok{id} \OperatorTok{+} \StringTok{\textquotesingle{}{-}boxxy{-}value\textquotesingle{}}\OperatorTok{,} \DecValTok{0}\OperatorTok{,}\NormalTok{ data}\OperatorTok{.}\AttributeTok{value}
\NormalTok{      )}\OperatorTok{;}
\NormalTok{      counter}\OperatorTok{.}\FunctionTok{start}\NormalTok{()}\OperatorTok{;}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
\NormalTok{      boxValue }\OperatorTok{=} \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(el}\OperatorTok{.}\AttributeTok{id} \OperatorTok{+} \StringTok{\textquotesingle{}{-}boxxy{-}value\textquotesingle{}}\NormalTok{)}
\NormalTok{      boxValue}\OperatorTok{.}\AttributeTok{innerText} \OperatorTok{=}\NormalTok{ data}\OperatorTok{.}\AttributeTok{value}\OperatorTok{;}
\NormalTok{    \}}

\NormalTok{    boxTitle }\OperatorTok{=} \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(el}\OperatorTok{.}\AttributeTok{id} \OperatorTok{+} \StringTok{\textquotesingle{}{-}boxxy{-}title\textquotesingle{}}\NormalTok{)}
\NormalTok{    boxTitle}\OperatorTok{.}\AttributeTok{innerText} \OperatorTok{=}\NormalTok{ data}\OperatorTok{.}\AttributeTok{title}\OperatorTok{;}
\NormalTok{  \}}
\NormalTok{\})}\OperatorTok{;}
...
\NormalTok{output}\OperatorTok{$}\NormalTok{theId \textless{}{-}}\StringTok{ }\KeywordTok{renderBoxxy}\NormalTok{(\{}
  \KeywordTok{list}\NormalTok{(}
...
\begin{Highlighting}[]
\CommentTok{\# app.R}
\NormalTok{switchInput \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id) \{}
...
\begin{Highlighting}[]
\CommentTok{\# app.R}
\NormalTok{switchInput \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id, label, }\DataTypeTok{checked =} \OtherTok{TRUE}\NormalTok{) \{}

\NormalTok{  input \textless{}{-}}\StringTok{ }\NormalTok{tags}\OperatorTok{$}\KeywordTok{input}\NormalTok{(}
    \DataTypeTok{id =}\NormalTok{ id, }
    \DataTypeTok{type =} \StringTok{"checkbox"}\NormalTok{, }
    \DataTypeTok{class =} \StringTok{"switchInput"}
\NormalTok{  )}
...
\NormalTok{    input \textless{}{-}}\StringTok{ }\NormalTok{htmltools}\OperatorTok{::}\KeywordTok{tagAppendAttributes}\NormalTok{(input, }\DataTypeTok{checked =} \OtherTok{NA}\NormalTok{)}

\NormalTok{  form \textless{}{-}}\StringTok{ }\KeywordTok{tagList}\NormalTok{(}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{update\_switch\_input \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id, value, }
  \DataTypeTok{session =}\NormalTok{ shiny}\OperatorTok{::}\KeywordTok{getDefaultReactiveDomain}\NormalTok{())\{}
...
\NormalTok{  \})}
  ...
  \KeywordTok{observeEvent}\NormalTok{(input}\OperatorTok{$}\NormalTok{chg, \{}
    \KeywordTok{update\_switch\_input}\NormalTok{(}\StringTok{"switch"}\NormalTok{, }\OtherTok{TRUE}\NormalTok{, session)}
\NormalTok{  \})}
\NormalTok{\}}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(V8)}
\CommentTok{\#\textgreater{} Using V8 engine 6.8.275.32{-}node.55}
...
\CommentTok{\#\textgreater{}   \},}
\CommentTok{\#\textgreater{}   \{}
\CommentTok{\#\textgreater{}     "speed": 7,}
\CommentTok{\#\textgreater{}     "dist": 4}
\CommentTok{\#\textgreater{}   \}}
\CommentTok{\#\textgreater{} ]}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] "Sun Oct 18 2020 18:34:45 GMT+0200 (Central European Summer Time)"}
...
\CommentTok{\#\textgreater{} [}
\CommentTok{\#\textgreater{}   \{}
\CommentTok{\#\textgreater{}     "title": "Rights of Man",}
\CommentTok{\#\textgreater{}     "id": "a"}
\CommentTok{\#\textgreater{}   \},}
\CommentTok{\#\textgreater{}   \{}
\CommentTok{\#\textgreater{}     "title": "Black Swan",}
\CommentTok{\#\textgreater{}     "id": "b"}
\CommentTok{\#\textgreater{}   \},}
\CommentTok{\#\textgreater{}   \{}
\CommentTok{\#\textgreater{}     "title": "Common Sense",}
\CommentTok{\#\textgreater{}     "id": "c"}
\CommentTok{\#\textgreater{}   \},}
\CommentTok{\#\textgreater{}   \{}
\CommentTok{\#\textgreater{}     "title": "Sense and Sensibility",}
\CommentTok{\#\textgreater{}     "id": "d"}
\CommentTok{\#\textgreater{}   \}}
\CommentTok{\#\textgreater{} ]}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] "172800000"}
...
\CommentTok{\#\textgreater{} [1] 36000000}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\#\textgreater{} [1] 3.364908}
\KeywordTok{predict}\NormalTok{(model\_cars, }\DecValTok{15}\NormalTok{)}
\CommentTok{\#\textgreater{} [1] 10.76742}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{function} \FunctionTok{hello}\NormalTok{(my\_variable)\{}
    \KeywordTok{let}\NormalTok{ total }\OperatorTok{=}\NormalTok{ number }\OperatorTok{+}\NormalTok{ my\_variable}\OperatorTok{;}
    \BuiltInTok{console}\OperatorTok{.}\FunctionTok{log}\NormalTok{(total)}\OperatorTok{;}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{let}\NormalTok{ number}\OperatorTok{=}\DecValTok{41}\OperatorTok{;}\KeywordTok{function} \FunctionTok{hello}\NormalTok{(e)\{}\KeywordTok{let}\NormalTok{ l}\OperatorTok{=}\NormalTok{number}\OperatorTok{+}\NormalTok{e}\OperatorTok{;}\BuiltInTok{console}\OperatorTok{.}\FunctionTok{log}\NormalTok{(l)\}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{\textless{}script}\OtherTok{ src=}\StringTok{"utils.js"}\KeywordTok{\textgreater{}\textless{}/script\textgreater{}}
\KeywordTok{\textless{}script}\OtherTok{ src=}\StringTok{"main.js"}\KeywordTok{\textgreater{}\textless{}/script\textgreater{}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{server \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(...) \{\}}
...
\NormalTok{mainJs \textless{}{-}}\StringTok{ }\NormalTok{htmltools}\OperatorTok{::}\KeywordTok{htmlDependency}\NormalTok{(}
...
\NormalTok{module}\OperatorTok{.}\AttributeTok{exports} \OperatorTok{=}\NormalTok{ \{}
  ...
  \DataTypeTok{externals}\OperatorTok{:}\NormalTok{ \{}
...
\CommentTok{// valid}
\ImportTok{export} \ImportTok{default} \KeywordTok{function} \FunctionTok{sayHello}\NormalTok{() \{}
\NormalTok{  alert(}\StringTok{"Hello!"}\NormalTok{)}
\NormalTok{\}}\OperatorTok{;}
...
\ImportTok{export} \ImportTok{default}\NormalTok{ \{x}\OperatorTok{,}\NormalTok{ y\}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Mousetrap}\OperatorTok{.}\FunctionTok{bind}\NormalTok{(secret}\OperatorTok{,} \KeywordTok{function}\NormalTok{() \{ }
\NormalTok{  Shiny}\OperatorTok{.}\FunctionTok{setInputValue}\NormalTok{(}\StringTok{\textquotesingle{}secret\textquotesingle{}}\OperatorTok{,} \KeywordTok{true}\NormalTok{)}\OperatorTok{;}
\NormalTok{\})}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{server \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(input, output) \{}
\NormalTok{  output}\OperatorTok{$}\NormalTok{hello \textless{}{-}}\StringTok{ }\KeywordTok{renderUI}\NormalTok{(\{}
...
\NormalTok{✔ }\ExtensionTok{Setting}\NormalTok{ active project to }\StringTok{\textquotesingle{}/javascript{-}for{-}r/code/increment\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}\^{}srcjs$\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.Rbuildignore\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}\^{}node\_modules$\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.Rbuildignore\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}\^{}package\textbackslash{}\textbackslash{}.json$\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.Rbuildignore\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}\^{}package{-}lock\textbackslash{}\textbackslash{}.json$\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.Rbuildignore\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}\^{}webpack\textbackslash{}\textbackslash{}.dev\textbackslash{}\textbackslash{}.js$\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.Rbuildignore\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}\^{}webpack\textbackslash{}\textbackslash{}.prod\textbackslash{}\textbackslash{}.js$\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.Rbuildignore\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}\^{}webpack\textbackslash{}\textbackslash{}.common\textbackslash{}\textbackslash{}.js$\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.Rbuildignore\textquotesingle{}}
\NormalTok{✔ }\ExtensionTok{Adding} \StringTok{\textquotesingle{}node\_modules\textquotesingle{}}\NormalTok{ to }\StringTok{\textquotesingle{}.gitignore\textquotesingle{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{incrementInput \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(inputId, }\DataTypeTok{value =} \DecValTok{0}\NormalTok{)\{}
...
\CommentTok{\#\textquotesingle{} library(shiny)}
\CommentTok{\#\textquotesingle{} }
\CommentTok{\#\textquotesingle{} ui \textless{}{-} fluidPage(}
\CommentTok{\#\textquotesingle{}  incrementInput("theId", 0)}
\CommentTok{\#\textquotesingle{} )}
\CommentTok{\#\textquotesingle{} }
\CommentTok{\#\textquotesingle{} server \textless{}{-} function(input, output)\{}
\CommentTok{\#\textquotesingle{} }
\CommentTok{\#\textquotesingle{}  observeEvent(input$theId, \{}
\CommentTok{\#\textquotesingle{}    print(input$theId)}
\CommentTok{\#\textquotesingle{}  \})}
\CommentTok{\#\textquotesingle{} }
\CommentTok{\#\textquotesingle{} \}}
\CommentTok{\#\textquotesingle{} }
\CommentTok{\#\textquotesingle{} if(interactive())}
\CommentTok{\#\textquotesingle{}  shinyApp(ui, server)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{import}\NormalTok{ $ }\ImportTok{from} \StringTok{\textquotesingle{}jquery\textquotesingle{}}\OperatorTok{;}
\ImportTok{import} \StringTok{\textquotesingle{}shiny\textquotesingle{}}\OperatorTok{;}

\NormalTok{$(}\BuiltInTok{document}\NormalTok{)}\OperatorTok{.}\FunctionTok{on}\NormalTok{(}\StringTok{"click"}\OperatorTok{,} \StringTok{"button.incrementBinding"}\OperatorTok{,} 
  \KeywordTok{function}\NormalTok{(evt) \{}
    \CommentTok{// evt.target is the button that was clicked}
    \KeywordTok{var}\NormalTok{ el }\OperatorTok{=}\NormalTok{ $(evt}\OperatorTok{.}\AttributeTok{target}\NormalTok{)}\OperatorTok{;}

    \CommentTok{// Set the button\textquotesingle{}s text to its current value plus 1}
\NormalTok{    el}\OperatorTok{.}\FunctionTok{text}\NormalTok{(}\PreprocessorTok{parseInt}\NormalTok{(el}\OperatorTok{.}\FunctionTok{text}\NormalTok{()) }\OperatorTok{+} \DecValTok{1}\NormalTok{)}\OperatorTok{;}

    \CommentTok{// Raise an event to signal that the value changed}
\NormalTok{    el}\OperatorTok{.}\FunctionTok{trigger}\NormalTok{(}\StringTok{"change"}\NormalTok{)}\OperatorTok{;}
\NormalTok{  \}}
\NormalTok{)}\OperatorTok{;}

\KeywordTok{var}\NormalTok{ incrementBinding }\OperatorTok{=} \KeywordTok{new}\NormalTok{ Shiny}\OperatorTok{.}\FunctionTok{InputBinding}\NormalTok{()}\OperatorTok{;}

\NormalTok{$}\OperatorTok{.}\FunctionTok{extend}\NormalTok{(incrementBinding}\OperatorTok{,}\NormalTok{ \{}
  \DataTypeTok{find}\OperatorTok{:} \KeywordTok{function}\NormalTok{(scope) \{}
    \ControlFlowTok{return}\NormalTok{ $(scope)}\OperatorTok{.}\FunctionTok{find}\NormalTok{(}\StringTok{".incrementBinding"}\NormalTok{)}\OperatorTok{;}
\NormalTok{  \}}\OperatorTok{,}
  \DataTypeTok{getValue}\OperatorTok{:} \KeywordTok{function}\NormalTok{(el) \{}
    \ControlFlowTok{return} \PreprocessorTok{parseInt}\NormalTok{($(el)}\OperatorTok{.}\FunctionTok{text}\NormalTok{())}\OperatorTok{;}
\NormalTok{  \}}\OperatorTok{,}
  \DataTypeTok{setValue}\OperatorTok{:} \KeywordTok{function}\NormalTok{(el}\OperatorTok{,}\NormalTok{ value) \{}
\NormalTok{    $(el)}\OperatorTok{.}\FunctionTok{text}\NormalTok{(value)}\OperatorTok{;}
\NormalTok{  \}}\OperatorTok{,}
  \DataTypeTok{subscribe}\OperatorTok{:} \KeywordTok{function}\NormalTok{(el}\OperatorTok{,}\NormalTok{ callback) \{}
\NormalTok{    $(el)}\OperatorTok{.}\FunctionTok{on}\NormalTok{(}\StringTok{"change.incrementBinding"}\OperatorTok{,} \KeywordTok{function}\NormalTok{(e) \{}
\NormalTok{      callback()}\OperatorTok{;}
\NormalTok{    \})}\OperatorTok{;}
\NormalTok{  \}}\OperatorTok{,}
  \DataTypeTok{unsubscribe}\OperatorTok{:} \KeywordTok{function}\NormalTok{(el) \{}
\NormalTok{    $(el)}\OperatorTok{.}\FunctionTok{off}\NormalTok{(}\StringTok{".incrementBinding"}\NormalTok{)}\OperatorTok{;}
\NormalTok{  \}}
\NormalTok{\})}\OperatorTok{;}

\NormalTok{Shiny}\OperatorTok{.}\AttributeTok{inputBindings}\OperatorTok{.}\FunctionTok{register}\NormalTok{(}
...
\ImportTok{import}\NormalTok{ \{ asHeader \} }\ImportTok{from} \StringTok{\textquotesingle{}../modules/header.js\textquotesingle{}}\OperatorTok{;} 
  ...
  \DataTypeTok{factory}\OperatorTok{:} \KeywordTok{function}\NormalTok{(el}\OperatorTok{,}\NormalTok{ width}\OperatorTok{,}\NormalTok{ height) \{}
    ...
    \ControlFlowTok{return}\NormalTok{ \{}
      ...
      \DataTypeTok{renderValue}\OperatorTok{:} \KeywordTok{function}\NormalTok{(x) \{}
        ...
        \CommentTok{// }\AlertTok{TODO}\CommentTok{: code to render the widget, e.g.}
\NormalTok{        el}\OperatorTok{.}\AttributeTok{innerHTML} \OperatorTok{=}\NormalTok{ asHeader(x)}\OperatorTok{;}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{const}\NormalTok{ asHeader }\OperatorTok{=}\NormalTok{ (x) }\KeywordTok{=\textgreater{}}\NormalTok{ \{}
  \ControlFlowTok{return} \StringTok{\textquotesingle{}\textless{}h1\textgreater{}\textquotesingle{}} \OperatorTok{+}\NormalTok{ x}\OperatorTok{.}\AttributeTok{message} \OperatorTok{+} \StringTok{\textquotesingle{}\textless{}/h1\textgreater{}\textquotesingle{}}\OperatorTok{;}
\NormalTok{\}}

\ImportTok{export}\NormalTok{ \{ asHeader \}}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\ImportTok{import}\NormalTok{ \{ CountUp \} }\ImportTok{from} \StringTok{\textquotesingle{}countup.js\textquotesingle{}}\OperatorTok{;}

\KeywordTok{function} \FunctionTok{counter}\NormalTok{(id}\OperatorTok{,}\NormalTok{ value)\{}
  \KeywordTok{var}\NormalTok{ countUp }\OperatorTok{=} \KeywordTok{new}\NormalTok{ CountUp(id}\OperatorTok{,}\NormalTok{ value)}\OperatorTok{;}
\NormalTok{  countUp}\OperatorTok{.}\FunctionTok{start}\NormalTok{()}\OperatorTok{;}
\NormalTok{\}}

\ImportTok{export}\NormalTok{ \{ counter \}}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\ImportTok{import} \StringTok{\textquotesingle{}widgets\textquotesingle{}}\OperatorTok{;}
\ImportTok{import}\NormalTok{ \{ counter \} }\ImportTok{from} \StringTok{\textquotesingle{}../modules/count.js\textquotesingle{}}\OperatorTok{;} 
...
\NormalTok{        counter(el}\OperatorTok{.}\AttributeTok{id}\OperatorTok{,}\NormalTok{ x}\OperatorTok{.}\AttributeTok{message}\NormalTok{)}\OperatorTok{;}
...
\section{Shiny with Vue \& Bootstrap 4}\label{packer-adv-shiny-vue}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{golem}\OperatorTok{::}\KeywordTok{create\_golem}\NormalTok{(}\StringTok{"vuer"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
The scaffold also sets up webpack with Babel; the transpiler that allows writing the latest JavaScript and ensure it will run on (almost) any web browser. Hence we can use ES6 notation in places.

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{packer}\OperatorTok{::}\KeywordTok{scaffold\_golem}\NormalTok{(}\DataTypeTok{vue =} \OtherTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{new}\NormalTok{ Vue(\{}
  \DataTypeTok{el}\OperatorTok{:} \StringTok{"\#app"}\OperatorTok{,}
  \DataTypeTok{template}\OperatorTok{:} \StringTok{"\textless{}App/\textgreater{}"}\OperatorTok{,}
  \DataTypeTok{components}\OperatorTok{:}\NormalTok{ \{ App \}}
\NormalTok{\})}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\ImportTok{import}\NormalTok{ Vue }\ImportTok{from} \StringTok{"vue"}\OperatorTok{;}
\ImportTok{import}\NormalTok{ \{ BootstrapVue}\OperatorTok{,}\NormalTok{ IconsPlugin \} }\ImportTok{from} \StringTok{\textquotesingle{}bootstrap{-}vue\textquotesingle{}}
...
\NormalTok{Vue}\OperatorTok{.}\FunctionTok{use}\NormalTok{(BootstrapVue)}
\NormalTok{Vue}\OperatorTok{.}\FunctionTok{use}\NormalTok{(IconsPlugin)}
...
\OperatorTok{\textless{}}\NormalTok{template}\OperatorTok{\textgreater{}}
  \OperatorTok{\textless{}}\NormalTok{p}\OperatorTok{\textgreater{}}\NormalTok{\{\{ greeting \}\} powered by Vue}\OperatorTok{!\textless{}/}\NormalTok{p}\OperatorTok{\textgreater{}}
\OperatorTok{\textless{}/}\NormalTok{template}\OperatorTok{\textgreater{}}

\OperatorTok{\textless{}}\NormalTok{script}\OperatorTok{\textgreater{}}
\NormalTok{module}\OperatorTok{.}\AttributeTok{exports} \OperatorTok{=}\NormalTok{ \{}
  \DataTypeTok{data}\OperatorTok{:} \KeywordTok{function}\NormalTok{() \{}
    \ControlFlowTok{return}\NormalTok{ \{}
...
\OperatorTok{\textless{}}\NormalTok{template}\OperatorTok{\textgreater{}}
  \OperatorTok{\textless{}}\NormalTok{div}\OperatorTok{\textgreater{}}
    \OperatorTok{\textless{}}\NormalTok{b}\OperatorTok{{-}}\NormalTok{form}\OperatorTok{{-}}\NormalTok{input }
...
\NormalTok{      @keyup}\OperatorTok{.}\AttributeTok{enter}\OperatorTok{=}\StringTok{"processText"}\OperatorTok{\textgreater{}}
    \OperatorTok{\textless{}/}\NormalTok{b}\OperatorTok{{-}}\NormalTok{form}\OperatorTok{{-}}\NormalTok{input}\OperatorTok{\textgreater{}}
    \OperatorTok{\textless{}}\NormalTok{b}\OperatorTok{{-}}\NormalTok{button }
\NormalTok{      @click}\OperatorTok{=}\StringTok{"processText"} 
\NormalTok{      variant}\OperatorTok{=}\StringTok{"outline{-}primary"}\OperatorTok{\textgreater{}}
\NormalTok{      Button}
    \OperatorTok{\textless{}/}\NormalTok{b}\OperatorTok{{-}}\NormalTok{button}\OperatorTok{\textgreater{}}
    \OperatorTok{\textless{}}\NormalTok{h2}\OperatorTok{\textgreater{}}\NormalTok{Your name is \{\{ text \}\}}\OperatorTok{\textless{}/}\NormalTok{h2}\OperatorTok{\textgreater{}}
  \OperatorTok{\textless{}/}\NormalTok{div}\OperatorTok{\textgreater{}}
\OperatorTok{\textless{}/}\NormalTok{template}\OperatorTok{\textgreater{}}
...
\NormalTok{  \}}\OperatorTok{,}
  \DataTypeTok{methods}\OperatorTok{:}\NormalTok{ \{}
    \DataTypeTok{processText}\OperatorTok{:} \KeywordTok{function}\NormalTok{()\{}
      \KeywordTok{this}\OperatorTok{.}\AttributeTok{text} \OperatorTok{=} \KeywordTok{this}\OperatorTok{.}\AttributeTok{inputText} \CommentTok{// set text var}
\NormalTok{      Shiny}\OperatorTok{.}\FunctionTok{setInputValue}\NormalTok{(}\StringTok{\textquotesingle{}text\textquotesingle{}}\OperatorTok{,} \KeywordTok{this}\OperatorTok{.}\AttributeTok{text}\NormalTok{)}\OperatorTok{;}
      \KeywordTok{this}\OperatorTok{.}\AttributeTok{inputText} \OperatorTok{=} \StringTok{\textquotesingle{}\textquotesingle{}} \CommentTok{// remove input once entered}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}\OperatorTok{;}
\OperatorTok{\textless{}/}\NormalTok{script}\OperatorTok{\textgreater{}}
