...
\begin{verbatim}
## Warning: package 'jsonlite' was built under R version
## 4.0.2
\end{verbatim}
...
\hypertarget{shiny-complete-events}{%
\section{Events \& Callbacks}\label{shiny-complete-events}}
...
\hypertarget{shiny-complete-pkg-r-code}{%
\subsection{R Code}\label{shiny-complete-pkg-r-code}}
...
\chapter{Rmarkdown}\label{rmd-intro}}

Rmarkdown \citep{R-rmarkdown} is an R package that allows the creation of documents from R, these range from presentations with xaringan \citep{R-xaringan}, through dashboard with flexdashboard \citep{R-flexdashboard} to entire books such as this one with bookdown \citep{R-bookdown}.
...
\hypertarget{xaringanextra}{%
\subsection{xaringanExtra}\label{xaringanextra}}
...
\begin{verbatim}
## [1] "Thu Sep 17 2020 17:09:36 GMT+0200 (Central European Summer Time)"
\end{verbatim}
...
\hypertarget{v8-img-handler}{%
\section{Input Handler}\label{v8-img-handler}}
...
\hypertarget{progress-js-code}{%
\section{JavaScript Code}\label{progress-js-code}}
