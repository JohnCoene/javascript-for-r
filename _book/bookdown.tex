...
\item
  The book opens with an introduction to better understand its premise. It starts with rationales for using JavaScript in conjunction with R which are illustrated with existing R packages that actually make use of JavaScript. Then the book briefly describes concepts essential to understand the content of the book. Finally, the chapter closes by listing the various methods with which one might make JavaScript work with R.
\item
...
\begin{verbatim}
## [1] "Tue Jul 07 2020 18:40:01 GMT+0200 (Central European Summer Time)"
\end{verbatim}
