...
\begin{verbatim}
## [1] "Sun Jul 12 2020 20:16:51 GMT+0200 (Central European Summer Time)"
\end{verbatim}
...
Also keep the previous remark in mind when repeatedly serialising data objects, GeoJSON is again a good example. Often, geographic features are not used once but multiple times within a web page (multiple maps); this data should not be processed multiple multiple times: it would be inefficient given these geographic features do not change. Consider providing other ways to for the developer to make potentially large data files accessible to the browser.
