...
\CommentTok{\#> <FeatureCollection>}
\CommentTok{\#>   Bounding box: {-}112.1 46.6 {-}112.0 46.6}
\CommentTok{\#>   No. features: 2}
\CommentTok{\#>   No. points: 20}
\CommentTok{\#>   Properties: }
\CommentTok{\#>     values count}
\CommentTok{\#> 1 200, 600     2}
\CommentTok{\#> 2              0}
\end{Highlighting}
\end{Shaded}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{1-01-intro-introduction_files/figure-latex/unnamed-chunk-2-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{1-01-intro-introduction_files/figure-latex/unnamed-chunk-4-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{1-01-intro-introduction_files/figure-latex/unnamed-chunk-5-1}
...
Importantly, \texttt{const} is mainly protecting yourself (the developer) against yourself, if something important is defined and should not change later in the code use \texttt{const} to avoid accidentally reassigning something to it later in the project.
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{1-02-basics_files/figure-latex/unnamed-chunk-15-1}
...
\NormalTok{) }
\CommentTok{\#> [[1]]}
\CommentTok{\#> List of 10}
\CommentTok{\#>  $ name      : chr "bootstrap"}
\CommentTok{\#>  $ version   : chr "3.4.1"}
\CommentTok{\#>  $ src       :List of 2}
\CommentTok{\#>   ..$ href: chr "shared/bootstrap"}
\CommentTok{\#>   ..$ file: chr "/home/jp/R/x86\_64{-}pc{-}linux{-}gnu{-}library/4.0/shiny/www/shared/bootstrap"}
\CommentTok{\#>  $ meta      :List of 1}
\CommentTok{\#>   ..$ viewport: chr "width=device{-}width, initial{-}scale=1"}
\CommentTok{\#>  $ script    : chr [1:3] "js/bootstrap.min.js" "shim/html5shiv.min.js" "shim/respond.min.js"}
\CommentTok{\#>  $ stylesheet: chr "css/bootstrap.min.css"}
\CommentTok{\#>  $ head      : NULL}
\CommentTok{\#>  $ attachment: NULL}
\CommentTok{\#>  $ package   : NULL}
\CommentTok{\#>  $ all\_files : logi TRUE}
\CommentTok{\#>  {-} attr(*, "class")= chr "html\_dependency"}
\end{Highlighting}
\end{Shaded}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-20-htmlwidgets-intro_files/figure-latex/unnamed-chunk-1-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-20-htmlwidgets-intro_files/figure-latex/unnamed-chunk-2-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-20-htmlwidgets-intro_files/figure-latex/unnamed-chunk-4-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-20-htmlwidgets-intro_files/figure-latex/unnamed-chunk-5-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-21-htmlwidgets-basics_files/figure-latex/unnamed-chunk-1-1}
...
This is so htmlwidgets can internally match the output of \texttt{createWidget} to its JavaScript function. At this stage it is probably good to take a look at the diagram of what is happening.

\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-22-htmlwidgets-first_files/figure-latex/unnamed-chunk-2-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{peity\_html <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(...)\{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{myWidget\_html <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(..., class)\{}
...
\CommentTok{\#> [[1]]}
\CommentTok{\#> List of 10}
\CommentTok{\#>  $ name      : chr "three"}
\CommentTok{\#>  $ version   : chr "110"}
\CommentTok{\#>  $ src       :List of 1}
\CommentTok{\#>   ..$ file: chr "/home/jp/R/x86\_64{-}pc{-}linux{-}gnu{-}library/4.0/gio/htmlwidgets/three"}
\CommentTok{\#>  $ meta      : NULL}
\CommentTok{\#>  $ script    : chr "three.min.js"}
\CommentTok{\#>  $ stylesheet: NULL}
\CommentTok{\#>  $ head      : NULL}
\CommentTok{\#>  $ attachment: NULL}
\CommentTok{\#>  $ package   : NULL}
\CommentTok{\#>  $ all\_files : logi TRUE}
...
\CommentTok{\#> [[2]]}
\CommentTok{\#> List of 10}
\CommentTok{\#>  $ name      : chr "gio"}
\CommentTok{\#>  $ version   : chr "2"}
\CommentTok{\#>  $ src       :List of 1}
\CommentTok{\#>   ..$ file: chr "/home/jp/R/x86\_64{-}pc{-}linux{-}gnu{-}library/4.0/gio/htmlwidgets/gio"}
\CommentTok{\#>  $ meta      : NULL}
\CommentTok{\#>  $ script    : chr "gio.min.js"}
\CommentTok{\#>  $ stylesheet: NULL}
\CommentTok{\#>  $ head      : NULL}
\CommentTok{\#>  $ attachment: NULL}
\CommentTok{\#>  $ package   : NULL}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-26-htmlwidgets-crosstalk_files/figure-latex/unnamed-chunk-4-1}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{sd\_cars <{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(cars[}\DecValTok{1}\OperatorTok{:}\DecValTok{2}\NormalTok{,])}
\end{Highlighting}
\end{Shaded}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-26-htmlwidgets-crosstalk_files/figure-latex/unnamed-chunk-9-1}
...
\NormalTok{shared\_cars\_head <{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(}\KeywordTok{head}\NormalTok{(mtcars), }\DataTypeTok{group =} \StringTok{"cars"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{shared\_arcs <{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(arcs, }\DataTypeTok{key =}\NormalTok{ arcs}\OperatorTok{$}\NormalTok{e)}
...
\CommentTok{\#> [1] "SharedData469894cf"}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-26-htmlwidgets-crosstalk_files/figure-latex/unnamed-chunk-16-1}
...
\CommentTok{\# Wrap data frame in SharedData}
\NormalTok{edges\_sd <{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(arcs, }\DataTypeTok{key =}\NormalTok{ arcs}\OperatorTok{$}\NormalTok{i, }\DataTypeTok{group =} \StringTok{"sharedGroup"}\NormalTok{)}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{4-11-shiny-first-look_files/figure-latex/unnamed-chunk-1-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{4-11-shiny-first-look_files/figure-latex/unnamed-chunk-2-1}
...
Let's exploit an external library to demonstrate how this works: \href{https://github.com/StephanWagner/jBox}{jBox} allows displaying ``notices,'' similar to vanilla JavaScript alerts, but much better looking and with additional functionalities.

The grand scheme is to build an application that displays a notification at the click of an \texttt{actionButton} and ``tells'' the server when that notification is closed. Though the introduction of this book includes best practices on how to include dependencies and JavaScript files much of that will be disregarded in this section (and only in this section) so it does not get in the way of explaining bidirectional communication through the websocket in shiny.
...
Below we add the handler for messages of type \texttt{send-notice}, the handler itself is a function that accepts the messages that was sent from the server and uses it to generate the notice via jBox.
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{4-11-shiny-first-look_files/figure-latex/unnamed-chunk-3-1}
...
\NormalTok{  session}\OperatorTok{$}\KeywordTok{sendCustomMessage}\NormalTok{(}\DataTypeTok{type =} \StringTok{"send{-}notice"}\NormalTok{, }\DataTypeTok{message =}\NormalTok{ notice)}
\NormalTok{\}}
...
This raises one issue, one cannot truly serialise to executable code. The attempt below serialises the function to a string that \emph{will not} be evaluated in JavaScript, just like \texttt{"function(x)\{\ x\ +\ 1\ \}"} is not evaluated in R: it's not a function, it's a string.
...
\StringTok{    // append callback}
\StringTok{    message.onClose = function()\{}
\StringTok{      Shiny.setInputValue(\textquotesingle{}notice\_close\textquotesingle{}, true, \{priority: \textquotesingle{}event\textquotesingle{}\});}
\StringTok{    \}}
\StringTok{    new jBox(\textquotesingle{}Notice\textquotesingle{}, message);}
\StringTok{\});"}\NormalTok{)}
\end{Highlighting}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{4-12-shiny-complete_files/figure-latex/unnamed-chunk-1-1}
...
We thus observe the button so that when clicked a message is sent to the front-end, via the websocket. Note that the \texttt{sendCustomMessage} method \textbf{must take data,} hence the empty \texttt{list} that is used as second argument. This of course won't do anything as we are yet to add a handler in JavaScript to handle this \texttt{classify} message that is sent.
...
Note that handlers can only be registered once, running the above twice will fail the second time, even if the handler function has changed. This is to ensure one does not accidentally overwrite handlers brought in by other packages. These can be overwritten by explicitely setting \texttt{force} to \texttt{TRUE} but it is not advised.
...
There will be need for a function that sends a message to the front-end to trigger the classification. In the application built previously the \texttt{id} of the image to classify was hard-coded, this must be changed when building a package.
...
\CommentTok{\#\textquotesingle{} @export}
\NormalTok{classify <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id, }\DataTypeTok{session =}\NormalTok{ shiny}\OperatorTok{::}\KeywordTok{getDefaultReactiveDomain}\NormalTok{())\{}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renderBoxxy <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(expr, }\DataTypeTok{env =} \KeywordTok{parent.frame}\NormalTok{(), }\DataTypeTok{quoted =} \OtherTok{FALSE}\NormalTok{) \{}
  \CommentTok{\# Convert the expression + environment into a function}
\NormalTok{  func <{-}}\StringTok{ }\NormalTok{shiny}\OperatorTok{::}\KeywordTok{exprToFunction}\NormalTok{(expr, env, quoted)}
...
\VariableTok{$}\NormalTok{.}\AttributeTok{extend}\NormalTok{(boxxyBinding}\OperatorTok{,} \OperatorTok{\{}
  ...
  \DataTypeTok{renderValue}\OperatorTok{:} \KeywordTok{function}\NormalTok{(el}\OperatorTok{,}\NormalTok{ data) }\OperatorTok{\{}
    ...
    \ControlFlowTok{if}\NormalTok{(}\VariableTok{data}\NormalTok{.}\AttributeTok{animate}\NormalTok{)}\OperatorTok{\{}
      \KeywordTok{var}\NormalTok{ counter }\OperatorTok{=} \KeywordTok{new} \AttributeTok{CountUp}\NormalTok{(}\VariableTok{el}\NormalTok{.}\AttributeTok{id} \OperatorTok{+} \StringTok{\textquotesingle{}{-}boxxy{-}value\textquotesingle{}}\OperatorTok{,} \DecValTok{0}\OperatorTok{,} \VariableTok{data}\NormalTok{.}\AttributeTok{value}\NormalTok{)}\OperatorTok{;}
      \VariableTok{counter}\NormalTok{.}\AttributeTok{start}\NormalTok{()}\OperatorTok{;}
    \OperatorTok{\}} \ControlFlowTok{else} \OperatorTok{\{}
      \VariableTok{document}\NormalTok{.}\AttributeTok{getElementById}\NormalTok{(}\VariableTok{el}\NormalTok{.}\AttributeTok{id} \OperatorTok{+} \StringTok{\textquotesingle{}{-}boxxy{-}value\textquotesingle{}}\NormalTok{).}\AttributeTok{innerText} \OperatorTok{=} \VariableTok{data}\NormalTok{.}\AttributeTok{value}\OperatorTok{;}
    \OperatorTok{\}}

    \VariableTok{document}\NormalTok{.}\AttributeTok{getElementById}\NormalTok{(}\VariableTok{el}\NormalTok{.}\AttributeTok{id} \OperatorTok{+} \StringTok{\textquotesingle{}{-}boxxy{-}title\textquotesingle{}}\NormalTok{).}\AttributeTok{innerText} \OperatorTok{=} \VariableTok{data}\NormalTok{.}\AttributeTok{title}\OperatorTok{;}
  \OperatorTok{\}}
\OperatorTok{\}}\NormalTok{)}\OperatorTok{;}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{update\_switch\_input <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id, value, }
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{4-16-shiny-input_files/figure-latex/unnamed-chunk-3-1}
...
\CommentTok{\#> [1] "Sun Oct 18 2020 18:34:45 GMT+0200 (Central European Summer Time)"}
...
It's the same problem one faces when writing R code. While a small script of 300 lines of code will do the job a large script of 10,000 lines quickly becomes unmanageable. Therefore when tackling larger projects the R programmer will turn to solutions that enforce a certain file structure and provides utilities harmonise how those files work together. Some of these solutions may include the drake \citep{R-drake}, or targets \citep{R-targets} packages both of which provide tools to manage complex workflows and pipelines. Another method often used is to build the project as an R package, thereby enforcing a structure as well as enabling reproducibility, unit tests, and more.

The above mentioned issues are also a concern in JavaScript though here one has to consider additional pitfalls. Like R, JavaScript is a constantly evolving language but while R code written on version \texttt{4.0.0} will likely run absolutely fine on version \texttt{3.0.0} it is not exactly the case for JavaScript. As the language evolves and changes web browsers have to keep up to support any new feature brought by new releases.
...
There is a lot of depth to NPM and webpack, we only touch the surface here so we can obtain a basic setup for a shiny application. We'll eventually go into slightly more details as this part of the book progress but it will by no means fully explore the realm of webpack. It's always a good idea to take a look at the \href{https://webpack.js.org/}{official documentation} in order to get a better picture of the technology.
...
\begin{rmdnote}
We are only going to use Node.js indirectly, some of its functionalities
...
Let us first put together a simple shiny application that which will serve as a basis for including webpack and npm. Create a new directory and place a file called \texttt{app.R} containing a very simple application.
...
With a simple application one can initialise NPM. This could be translated into the equivalent of starting a new project in R. This is done from the command line, \emph{from the root of the directory} that you want to use as project.

An npm project can be initialised with the command \texttt{npm\ init}, which when run prompts the user with a few questions, such as the name of the project, the license to use, etc. These have little importance for what we do here but will matter if you decide to publish the package on NPM. One can also pass the ``yes'' flag to the function in order to skip those questions: \texttt{npm\ init\ -y}.
...
Finally, there are the ``true'' dependencies, those that are needed in the output we're creating. For instance were we to rebuild the gio widget with NPM we could install it with \texttt{npm\ install\ giojs\ -\/-save} because this dependency will be required in the output file we produce.
...
The directory \texttt{node\_modules} actually holds all the dependencies, it will grow in size as you add dependencies, it's important that this directory is not pushed to whatever version control system you happen use (Github, Bitbucket, Gitlab).

\begin{rmdnote}
Do not commit \texttt{node\_modules} to git
\end{rmdnote}

The dependencies are any way not needed as one can pull the project without the \texttt{node\_modules} then from the root of the project run \texttt{npm\ install} as-is without package names to install the dependencies that are present in the \texttt{package.json}. This file was indeed update to include \texttt{webpack} and \texttt{webpack-cli} as \texttt{devDependencies}, at the bottom of the file.
...
The \texttt{package-lock.json} file is automatically generated and \emph{should not be edited manually,} it describes the exact tree of all the dependencies. If you installed a package by mistake you can uninstall it with \texttt{npm\ uninstall\ nameOfPage}.

\hypertarget{webpack-intro-entry-points}{%
\section{Entry Point \& Output}\label{webpack-intro-entry-points}}

In general, an NPM project with webpack will make use of a \texttt{src} directory where the source code is placed and a \texttt{dist} directory (for distributed) where the bundled source code will be placed. The \texttt{src} directory in R packages is reserved for compiled code (e.g.: C++) and therefore cannot be used, it will not be a problem here as we are not building a package.
...
Webpack will then require one or more entry points. An entry point is an input file in the \texttt{src} directory that webpack will bundle into the \texttt{dist} directory. Let's create the go-to example, the snippet below creates the \texttt{index.js} file with the basic ``hello world'' alert.
...
Webpack comes with its own configuration file, \texttt{webpack.config.js} though as we'll see one is later advised to split that into multiple configuration files. This file can include numerous options, plugins, and other settings to customise how webpack transforms the entry point into an output, some of those will be explored in this book but know that there are too many to cover.

The simplest file one may create is the one below. At the bare minimum the configuration file will need to have an entry point specified, below the \texttt{index.js} file previously created. If no \texttt{output} path is specified then webpack will produce it at \texttt{dist/main.js} automatically.
...
The \texttt{module.exports} line may confuse as this was not covered yet; it will be very soon.

\hypertarget{webpack-intro-npm-scripts}{%
\section{NPM scripts}\label{webpack-intro-npm-scripts}}

NPM scripts allow automating development tasks such are running unit tests, serving files, and more, we'll set it up to run webpack. The scripts are placed in the \texttt{package.json} file and are terminal commands that run in the terminal.

By default \texttt{npm-init} creates the following \texttt{test} script which simply echoes (prints) a message stating that no unit tests were set up.
...
One can then bundle the code using the scripts that we defined to produce the output bundle. Since we have not specified any \texttt{output} in webpack's configuration file it will produce it at the default location \texttt{dist/main.js}.
...
Running the above should present the \texttt{alert()} that was placed in the \texttt{index.js} original source file.
...
For instance, this project is intended to work with a shiny application which comes bundled with jQuery, and the shiny JavaScript library. Thankfully webpack comes with a simple mechanism to handle these cases. External dependencies can be added to the configuration file under \texttt{externals}.
...
The above will allow import \texttt{shiny} in scripts, so let's delve into the import/export mechanism.

\hypertarget{webpack-intro-import-export}{%
\section{Import \& Export}\label{webpack-intro-import-export}}

In order to demonstrate how webpack enables modularising code, not everything will be written in the \texttt{index.js} file. We can create another file, \texttt{secret.js}, that will contain the code to handle the key strokes via mousetrap and then import that file in \texttt{index.js}.
...
Before we place code in \texttt{secret.js} we will have it imported in \texttt{index.js}. Importing and exporting files can follow different syntaxes all of which cannot be covered here, it's somewhat outside the scope of this book. Here we will use \href{https://en.wikipedia.org/wiki/CommonJS}{CommonJS} syntax using \texttt{require}. To draw parallel to R think about \texttt{require} like a hybrid version of the function of the same name in R and \texttt{source}. In R we can import other R files with \texttt{source("script.R")} and import packages with \texttt{require(dplyr)} though using \texttt{library(dplyr)} is preferred.

The \texttt{require} function works very much the same way, it is used below to import the \texttt{secret.js} file but can also be used to import packages. We thus modify the \texttt{index.js} file so it imports \texttt{secret.js}, note that it uses \texttt{./} to indicate the path and is necessary, \texttt{require} will not work without it.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{// src/index.js}
\AttributeTok{require}\NormalTok{(}\StringTok{\textquotesingle{}./secret.js\textquotesingle{}}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\hypertarget{webpack-intro-import-final}{%
\section{Finalise}\label{webpack-intro-import-final}}

In the \texttt{secret.js} file we can now make use of mousetrap, the library is also imported with \texttt{require} as detailed on the project's Github page. It is used to bind key strokes (\texttt{secret}) to a callback function which sets the shiny input \texttt{secret} to \texttt{TRUE}.

Since \texttt{shiny} was added as external dependency it can also be imported with \texttt{require} as it is needed for \texttt{setInputValue}.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{// src/secret.js}
\KeywordTok{var}\NormalTok{ Shiny }\OperatorTok{=} \AttributeTok{require}\NormalTok{(}\StringTok{\textquotesingle{}shiny\textquotesingle{}}\NormalTok{)}
\KeywordTok{var}\NormalTok{ Mousetrap }\OperatorTok{=} \AttributeTok{require}\NormalTok{(}\StringTok{\textquotesingle{}mousetrap\textquotesingle{}}\NormalTok{)}\OperatorTok{;}

\VariableTok{Mousetrap}\NormalTok{.}\AttributeTok{bind}\NormalTok{(}\StringTok{\textquotesingle{}s e c r e t\textquotesingle{}}\OperatorTok{,} \KeywordTok{function}\NormalTok{() }\OperatorTok{\{} 
...
This can then be bundled with \texttt{npm\ run\ bundle-prod} and used in the shiny application which we modify so it listens to the \texttt{secret} input set and only when that input is set does it render a plot and a message.
...
\chapter{Packer}\label{packer-overview}}
