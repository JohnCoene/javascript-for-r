...
The \texttt{origData} method is needed to extract the data from the shared dataset. This is of course necessary as the \texttt{gio} function still needs to obtain and serialise data to display on the globe.
...
\CommentTok{\# Wrap data frame in SharedData}
\NormalTok{edges\_sd \textless{}{-}}\StringTok{ }\NormalTok{SharedData}\OperatorTok{$}\KeywordTok{new}\NormalTok{(arcs, }\DataTypeTok{key =}\NormalTok{ arcs}\OperatorTok{$}\NormalTok{i, }\DataTypeTok{group =} \StringTok{"gio"}\NormalTok{)}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-47-1.png}
...
\begin{verbatim}
## [1] "Mon Aug 24 2020 16:01:15 GMT+0200 (Central European Summer Time)"
\end{verbatim}
