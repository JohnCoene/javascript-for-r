...
The R programming language has been propelled into web browsers with the introduction of packages such as \href{@R-shiny}{shiny} and \href{@R-rmarkdown}{rmarkdown}. Yet most R developers are not familiar with one of web browsers core technology: JavaScript. This books aims to remedy to that by demonstrating how \emph{basic knowledge} of the language can lead to huge realisations otherwise locked away from R developers.
...
\item
  Then we delve into using JavaScript for computations, namely via the V8 engine and node.js. After a short introduction, chapters will walk the reader through various examples: a fuzzy search, a time format converter, and a basic natural language tokenizer.
\item
...
\begin{verbatim}
## [1] "Wed Jul 08 2020 11:48:52 GMT+0200 (Central European Summer Time)"
\end{verbatim}
...
We initialised a tokeniser then used its \texttt{tokenize} method to split the sentence into an array of words.
