...
\begin{verbatim}
## [1] "Fri Jun 26 2020 15:30:02 GMT+0200 (Central European Summer Time)"
\end{verbatim}
...
\KeywordTok{\textless{}body\textgreater{}}
  ...
  \KeywordTok{\textless{}script\textgreater{}}
    ...
    \KeywordTok{var}\NormalTok{ filter }\OperatorTok{=}\NormalTok{ LenaJS[}\StringTok{"inverted"}\NormalTok{]}\OperatorTok{;}
...
\NormalTok{    $(}\BuiltInTok{document}\NormalTok{)}\OperatorTok{.}\FunctionTok{ready}\NormalTok{(}\KeywordTok{function}\NormalTok{()\{}
      ...
      \KeywordTok{var}\NormalTok{ originalImage }\OperatorTok{=} \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(data}\OperatorTok{.}\AttributeTok{img\_id}\NormalTok{)}\OperatorTok{;}
      \CommentTok{// The canvas where the processed image will be rendered (With filter)}
      \KeywordTok{var}\NormalTok{ filteredImageCanvas }\OperatorTok{=} \BuiltInTok{document}\OperatorTok{.}\FunctionTok{getElementById}\NormalTok{(el}\OperatorTok{.}\AttributeTok{id}\NormalTok{)}\OperatorTok{;}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{attr}\NormalTok{(cars, }\StringTok{"hello"}\NormalTok{) \textless{}{-}}\StringTok{ "attributes"} \CommentTok{\# set }
...
\NormalTok{ui \textless{}{-}}\StringTok{ }\KeywordTok{fluidRow}\NormalTok{(}
...
In this short section we hammer in what was covered in this chapter by creating another function that sends data directly to JavaScript, namely \texttt{setStyle} so one can change the style.
...
\StringTok{      }\KeywordTok{gio\_send\_style}\NormalTok{(input}\OperatorTok{$}\NormalTok{style) }\OperatorTok{\%\textgreater{}\%}\StringTok{ }
\StringTok{      }\KeywordTok{gio\_send\_data}\NormalTok{(data)}
\NormalTok{  \})}
