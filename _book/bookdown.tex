...
\begin{verbatim}
## [1] "Sun Jun 07 2020 19:35:15 GMT+0200 (CEST)"
\end{verbatim}
...
Nonetheless, it is doable with htmlwdigets' serialiser (an only that one). The function \texttt{htmlwidgets::JS} can be used to mark a character vector so that it will be treated as JavaScript code when evaluated in the browser.
