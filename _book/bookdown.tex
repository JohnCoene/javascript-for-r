...
\caption{Package creation wizard}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{console.table output}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{Trying JavaScript}\label{fig:unnamed-chunk-13}
\end{figure}
...
\caption{Google Chrome Devtools}\label{fig:unnamed-chunk-15}
\end{figure}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{1-02-basics_files/figure-latex/unnamed-chunk-19-1}
...
\caption{DT package example}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Plotly example}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Highcharts example}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Chart.js example}\label{fig:unnamed-chunk-3}
\end{figure}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-21-htmlwidgets-basics_files/figure-latex/unnamed-chunk-4-1}
...
\caption{First widget}\label{fig:unnamed-chunk-2}
\end{figure}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-22-htmlwidgets-first_files/figure-latex/unnamed-chunk-3-1}
...
\caption{Console tab output}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Console tab output element}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{First widget output}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{First widget using shiny tags}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{Peity output with DIV}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Peity output with SPAN}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Gio.js example}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Gio output without data}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Gio output with correct serialisation}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Gio with a new theme}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Gio with no sizing management}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Gio with sizing policy}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Gio resized}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Gio output with title}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{Google Chrome network tab}\label{fig:unnamed-chunk-9}
\end{figure}
...
\caption{Gio with stats output}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Crosstalk example}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Shiny with crosstalk}\label{fig:unnamed-chunk-5}
\end{figure}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-26-htmlwidgets-crosstalk_files/figure-latex/unnamed-chunk-6-1}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-26-htmlwidgets-crosstalk_files/figure-latex/unnamed-chunk-11-1}
...
\CommentTok{\#> [1] "SharedData3a611abc"}
...
\caption{Gio with DT using crosstalk}\label{fig:unnamed-chunk-18}
\end{figure}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{3-26-htmlwidgets-crosstalk_files/figure-latex/unnamed-chunk-19-1}
...
\caption{Gio and plotly using crosstalk and groups}\label{fig:unnamed-chunk-20}
\end{figure}
...
\caption{Gio and plenty of options}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{A basic jBox notice}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{[A notice triggered by the server}\label{fig:unnamed-chunk-4}
\end{figure}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{4-11-shiny-first-look_files/figure-latex/unnamed-chunk-5-1}
...
\caption{Customised jBox notice}\label{fig:unnamed-chunk-7}
\end{figure}
...
\caption{jBox final application}\label{fig:unnamed-chunk-10}
\end{figure}
...
\caption{Shiny app skeleton}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Results logged to the console}\label{fig:unnamed-chunk-5}
\end{figure}
...
\caption{Classifier basic output}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Classifier table output}\label{fig:unnamed-chunk-8}
\end{figure}
...
\caption{Shiny with a busy indicator}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{DT with custom inputs}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Custom output example}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Shiny application with boxxy}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Checkbox and styled switch input}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Switch input example}\label{fig:unnamed-chunk-4}
\end{figure}
...
\textbackslash begin\{center\}\includegraphics[width=1\linewidth]{4-16-shiny-input_files/figure-latex/unnamed-chunk-5-1}
...
\caption{Shiny using cookies}\label{fig:unnamed-chunk-1}
\end{figure}
...
\caption{Gio with input data}\label{fig:unnamed-chunk-2}
\end{figure}
...
\caption{Gio input data transformed to a data frame}\label{fig:unnamed-chunk-3}
\end{figure}
...
\caption{Gio issue in shiny}\label{fig:unnamed-chunk-4}
\end{figure}
...
\caption{Gio with clear data proxy}\label{fig:unnamed-chunk-6}
\end{figure}
...
\caption{Gio with dynamic style}\label{fig:unnamed-chunk-7}
\end{figure}
...
\CommentTok{\#> }
\CommentTok{\#> $y}
\CommentTok{\#> [1] 10 15 13 17}
\CommentTok{\#> }
\CommentTok{\#> $mode}
\CommentTok{\#> [1] "markers"}
\CommentTok{\#> }
\CommentTok{\#> $type}
\CommentTok{\#> [1] "scatter"}
\end{Highlighting}
\end{Shaded}
