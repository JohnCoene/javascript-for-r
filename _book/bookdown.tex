...
\begin{verbatim}
## [1] "Sun Jun 07 2020 21:37:42 GMT+0200 (CEST)"
\end{verbatim}
...
This book previously explored how to send data to the from the shiny server to the front-end, this section looks to apply this to htmlwidgets. Currently, using htmlwidgets in shiny consist of generating the outputs using the \texttt{render} and complimentary \texttt{*Output} functions.
