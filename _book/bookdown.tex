...
\begin{figure}
\centering
\includegraphics{images/bootstrap-input-group-addon.png}
\caption{Bootstrap 3 input group addons}
\end{figure}
...
This CSS changes a standard checkbox to look like a switch.
...
\NormalTok{    tags}\OperatorTok{$}\KeywordTok{input}\NormalTok{(}\DataTypeTok{id =}\NormalTok{ id, }\DataTypeTok{type =} \StringTok{"checkbox"}\NormalTok{, }\DataTypeTok{class =} \StringTok{"switch{-}input"}\NormalTok{, }\DataTypeTok{checked=}\StringTok{"true"}\NormalTok{),}
...
\NormalTok{switchInput <{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(id) \{}
  ...
  \CommentTok{\# HTML}
\NormalTok{  form <{-}}\StringTok{ }\NormalTok{tags}\OperatorTok{$}\KeywordTok{label}\NormalTok{(}
    \DataTypeTok{class =} \StringTok{"switch"}\NormalTok{,}
\NormalTok{    tags}\OperatorTok{$}\KeywordTok{input}\NormalTok{(}\DataTypeTok{id =}\NormalTok{ id, }\DataTypeTok{type =} \StringTok{"checkbox"}\NormalTok{, }\DataTypeTok{class =} \StringTok{"switch{-}input"}\NormalTok{, }\DataTypeTok{checked=}\StringTok{"true"}\NormalTok{),}
\NormalTok{    tags}\OperatorTok{$}\KeywordTok{span}\NormalTok{(}\DataTypeTok{class =} \StringTok{"slider"}\NormalTok{)}
\NormalTok{  )}
...
\NormalTok{  deps <{-}}\StringTok{ }\NormalTok{htmltools}\OperatorTok{::}\KeywordTok{htmlDependency}\NormalTok{(}
    \DataTypeTok{name =} \StringTok{"textInputPlus"}\NormalTok{,}
    \DataTypeTok{version =} \StringTok{"1.0.0"}\NormalTok{,}
    \DataTypeTok{src =} \KeywordTok{c}\NormalTok{(}\DataTypeTok{file =}\NormalTok{ path),}
...
\begin{verbatim}
## [1] "Sun Aug 30 2020 17:33:26 GMT+0200 (Central European Summer Time)"
\end{verbatim}
