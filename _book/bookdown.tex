...
\begin{verbatim}
## [1] "Mon Jun 22 2020 23:30:20 GMT+0200 (Central European Summer Time)"
\end{verbatim}
...
\NormalTok{ui <{-}}\StringTok{ }\KeywordTok{fluidPage}\NormalTok{(}
\NormalTok{  tags}\OperatorTok{$}\KeywordTok{img}\NormalTok{(}\DataTypeTok{src =} \StringTok{"www/r{-}logo.png"}\NormalTok{, }\DataTypeTok{id =} \StringTok{"toFilter"}\NormalTok{),}
...
\NormalTok{  output}\OperatorTok{$}\NormalTok{filtered <{-}}\StringTok{ }\KeywordTok{renderLena}\NormalTok{(\{}
    \KeywordTok{lena}\NormalTok{(}\StringTok{"toFilter"}\NormalTok{, }\StringTok{"invert"}\NormalTok{)}
\NormalTok{  \})}
