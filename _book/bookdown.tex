...
\begin{verbatim}
## [1] "Wed Jun 10 2020 14:18:53 GMT+0200 (Central European Summer Time)"
\end{verbatim}
...
\NormalTok{.onUnload \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(libpath)\{}
...
\KeywordTok{\textless{}body\textgreater{}}
  ...
  \CommentTok{\textless{}!{-}{-} Script to create visualsiation {-}{-}\textgreater{}}
  \KeywordTok{\textless{}script\textgreater{}}
...
Nonetheless, it is doable with htmlwdigets' serialiser (and only that one). The function \texttt{htmlwidgets::JS} can be used to mark a character vector so that it will be treated as JavaScript code when evaluated in the browser.
...
\NormalTok{    controlle}\OperatorTok{.}\FunctionTok{addData}\NormalTok{(message}\OperatorTok{.}\AttributeTok{data}\NormalTok{)}\OperatorTok{;}
