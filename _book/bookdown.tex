...
\subsection{Htmltools}\label{htmltools}}
...
\hypertarget{dependencies-pros-and-cons}{%
\subsection{Dependencies Pros and Cons}\label{dependencies-pros-and-cons}}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-23-1.png}
...
\hypertarget{plotly.js}{%
\subsection{Plotly.js}\label{plotly.js}}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-26-1.png}
...
\hypertarget{the-htmlwidgets-scaffold}{%
\section{The Htmlwidgets Scaffold}\label{the-htmlwidgets-scaffold}}
...
\hypertarget{the-html-output}{%
\section{The HTML Output}\label{the-html-output}}
...
\hypertarget{htmlwidgets-javascript-files}{%
\section{Htmlwidgets JavaScript Files}\label{htmlwidgets-javascript-files}}
...
\hypertarget{peity.js-dependencies}{%
\section{Peity.js Dependencies}\label{peity.js-dependencies}}
...
\hypertarget{peity.js-implementation}{%
\section{Peity.js Implementation}\label{peity.js-implementation}}
...
\NormalTok{  htmltools}\OperatorTok{::}\KeywordTok{tagList}\NormalTok{(}
    \KeywordTok{peity}\NormalTok{(}\KeywordTok{runif}\NormalTok{(}\DecValTok{5}\NormalTok{)),}
\NormalTok{    htmltools}\OperatorTok{::}\KeywordTok{br}\NormalTok{(),}
    \KeywordTok{peity}\NormalTok{(}\KeywordTok{runif}\NormalTok{(}\DecValTok{5}\NormalTok{), }\DataTypeTok{type =} \StringTok{"line"}\NormalTok{),}
\NormalTok{    htmltools}\OperatorTok{::}\KeywordTok{br}\NormalTok{(),}
    \KeywordTok{peity}\NormalTok{(}\StringTok{"1/4"}\NormalTok{, }\DataTypeTok{type =} \StringTok{"pie"}\NormalTok{, }\DataTypeTok{fill =} \KeywordTok{c}\NormalTok{(}\StringTok{"\#c6d9fd"}\NormalTok{, }\StringTok{"\#4d89f9"}\NormalTok{)),}
\NormalTok{    htmltools}\OperatorTok{::}\KeywordTok{br}\NormalTok{(),}
...
\hypertarget{peity.js-html-element}{%
\section{Peity.js HTML Element}\label{peity.js-html-element}}
...
\hypertarget{gio.js-dependencies}{%
\section{Gio.js Dependencies}\label{gio.js-dependencies}}
...
\hypertarget{gio.js-javascript}{%
\section{Gio.js JavaScript}\label{gio.js-javascript}}
...
\hypertarget{using-javascript}{%
\subsection{Using JavaScript}\label{using-javascript}}
...
\hypertarget{on-print-method}{%
\section{On Print Method}\label{on-print-method}}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-42-1.png}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-44-1.png}
...
\includegraphics{bookdown_files/figure-latex/unnamed-chunk-50-1.png}
...
\hypertarget{htmlwidgets-data}{%
\section{Htmlwidgets \& Data}\label{htmlwidgets-data}}
...
\hypertarget{plotly.js-to-r}{%
\section{Plotly.js to R}\label{plotly.js-to-r}}
...
\hypertarget{r-to-plotly.js}{%
\section{R to Plotly.js}\label{r-to-plotly.js}}
...
\hypertarget{size-resize-plotly.js}{%
\section{Size \& Resize Plotly.js}\label{size-resize-plotly.js}}
...
\hypertarget{performance-security-with-plotly.js}{%
\section{Performance \& Security with Plotly.js}\label{performance-security-with-plotly.js}}
...
\hypertarget{websocket-shiny}{%
\section{Websocket \& Shiny}\label{websocket-shiny}}
...
\begin{center}\includegraphics[width=1\linewidth]{bookdown_files/figure-latex/unnamed-chunk-53-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{bookdown_files/figure-latex/unnamed-chunk-54-1} \end{center}
...
\hypertarget{alerts-an-example}{%
\section{Alerts, An Example}\label{alerts-an-example}}
...
\hypertarget{setup-custom-output}{%
\section{Setup Custom Output}\label{setup-custom-output}}
...
\hypertarget{output-r-function}{%
\section{Output R Function}\label{output-r-function}}
...
\hypertarget{generate-output-html}{%
\section{Generate Output HTML}\label{generate-output-html}}
...
\hypertarget{output-renderer}{%
\section{Output Renderer}\label{output-renderer}}
...
\hypertarget{boxxy-background-color}{%
\subsection{Boxxy Background Color}\label{boxxy-background-color}}
...
\hypertarget{injecting-dependencies}{%
\section{Injecting Dependencies}\label{injecting-dependencies}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{renderBoxxy \textless{}{-}}\StringTok{ }\ControlFlowTok{function}\NormalTok{(expr, }\DataTypeTok{env =} \KeywordTok{parent.frame}\NormalTok{(), }\DataTypeTok{quoted =} \OtherTok{FALSE}\NormalTok{) \{}
  \CommentTok{\# Convert the expression + environment into a function}
\NormalTok{  func \textless{}{-}}\StringTok{ }\NormalTok{shiny}\OperatorTok{::}\KeywordTok{exprToFunction}\NormalTok{(expr, env, quoted)}
...
\hypertarget{preprocessing-custom-outputs}{%
\section{Preprocessing Custom Outputs}\label{preprocessing-custom-outputs}}
...
\NormalTok{output}\OperatorTok{$}\NormalTok{theId \textless{}{-}}\StringTok{ }\KeywordTok{renderBoxxy}\NormalTok{(\{}
  \KeywordTok{list}\NormalTok{(}\DataTypeTok{title =} \StringTok{"The Title"}\NormalTok{, }\DataTypeTok{value =} \DecValTok{123}\NormalTok{, }\DataTypeTok{color =} \StringTok{"blue"}\NormalTok{, }\DataTypeTok{animate =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{custom-inputs}{%
\chapter{Custom Inputs}\label{custom-inputs}}
...
\hypertarget{setup-custom-input}{%
\section{Setup Custom Input}\label{setup-custom-input}}
...
\hypertarget{switch-input-html-style}{%
\section{Switch Input HTML \& Style}\label{switch-input-html-style}}
...
\hypertarget{generate-input-html}{%
\section{Generate Input HTML}\label{generate-input-html}}
...
\hypertarget{javascript-input-binding}{%
\section{JavaScript Input Binding}\label{javascript-input-binding}}
...
\hypertarget{find-inputs}{%
\subsection{Find Inputs}\label{find-inputs}}
...
\hypertarget{get-input-id}{%
\subsection{Get Input Id}\label{get-input-id}}
...
\hypertarget{get-input-value}{%
\subsection{Get Input Value}\label{get-input-value}}
...
\hypertarget{set-input-value}{%
\subsection{Set Input Value}\label{set-input-value}}
...
\hypertarget{receive-input-messages}{%
\subsection{Receive Input Messages}\label{receive-input-messages}}
...
\hypertarget{subscribe-unsubscribe-inputs}{%
\subsection{Subscribe \& Unsubscribe Inputs}\label{subscribe-unsubscribe-inputs}}
...
\hypertarget{input-rate-policy}{%
\subsection{Input Rate Policy}\label{input-rate-policy}}
...
\hypertarget{registering-the-input}{%
\subsection{Registering the Input}\label{registering-the-input}}
...
\begin{figure}
\centering
\includegraphics{images/switch-example.png}
\caption{Switch input example}
\end{figure}

\hypertarget{update-input}{%
\section{Update Input}\label{update-input}}
...
\begin{center}\includegraphics[width=1\linewidth]{bookdown_files/figure-latex/unnamed-chunk-63-1} \end{center}
...
\hypertarget{setup-cookies-project}{%
\section{Setup Cookies Project}\label{setup-cookies-project}}
...
\hypertarget{javascript-cookies}{%
\section{JavaScript Cookies}\label{javascript-cookies}}
...
\hypertarget{r-code-for-cookies}{%
\section{R Code for Cookies}\label{r-code-for-cookies}}
...
\hypertarget{widgets-to-r}{%
\section{Widgets to R}\label{widgets-to-r}}
...
\hypertarget{r-to-widgets}{%
\section{R to Widgets}\label{r-to-widgets}}
...
\hypertarget{send-data-from-widgets}{%
\subsection{Send Data from Widgets}\label{send-data-from-widgets}}
...
\hypertarget{update-the-widget}{%
\section{Update the Widget}\label{update-the-widget}}
...
\begin{verbatim}
## [1] "Fri Sep 04 2020 11:17:53 GMT+0200 (Central European Summer Time)"
\end{verbatim}
