...
\includegraphics{images/DT-example.png}
...
\CommentTok{\#> [1] "SharedData62cfcb05"}
...
\begin{figure}
\centering
\includegraphics{images/jbox-init.png}
\caption{A basic jBox notice}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{images/jbox-r2js.png}
\caption{A notice triggered by the server}
\end{figure}
...
\begin{figure}
\centering
\includegraphics{images/jbox-custom.png}
...
\includegraphics{images/jbox-end.png}
...
\NormalTok{fl <{-}}\StringTok{ }\KeywordTok{paste0}\NormalTok{(}
  \StringTok{"https://upload.wikimedia.org/wikipedia/commons/thumb/7/72/American\_flamingo\_\%28Phoenicopterus\_ruber\%29.JPG/256px{-}American\_flamingo\_\%28Phoenicopterus\_ruber\%29.JPG"}
\NormalTok{)}
...
\includegraphics{images/shiny-complete-skeleton.png}
...
\includegraphics{images/shiny-complete-classify-console.png}
...
\includegraphics{images/shiny-complete-table.png}
...
\includegraphics{images/ml5-pkg.png}
