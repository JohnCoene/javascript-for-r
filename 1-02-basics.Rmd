...
```{r, echo=FALSE, fig.cap='Package creation wizard'}
...
```{r, echo=FALSE, fig.cap='console.table output'}
...
```{r, echo=FALSE, fig.cap='Trying JavaScript'}
...
```{r, echo=FALSE, fig.cap='Google Chrome Devtools'}
