...
The very first thing to do is to import jBox in the project, we could download the files and use them as described in the previous static files section but it comes with very convenient CDNs detailed in the [get-started page of the documentation](https://stephanwagner.me/jBox/get_started). 
