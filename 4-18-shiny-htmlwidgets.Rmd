...
```{r gio-shiny-no-handler, echo=FALSE, fig.cap='Gio with input data'}
...
```{r gio-input-handler, echo=FALSE, fig.cap='Gio input data transformed to a data frame'}
...
```{r gio-shiny-error, echo=FALSE, fig.cap='Gio issue in shiny'}
...
```{r giod-shiny-clear-data, echo=FALSE, fig.cap='Gio with clear data proxy'}
...
```{r gio-shiny-style, echo=FALSE, fig.cap='Gio with dynamic style'}
