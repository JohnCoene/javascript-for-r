...
```{r, echo=FALSE, fig.cap='Gio with input data'}
...
```{r, echo=FALSE, fig.cap='Gio input data transformed to a data frame'}
...
```{r, echo=FALSE, fig.cap='Gio issue in shiny'}
...
```{r, echo=FALSE, fig.cap='Gio with clear data proxy'}
...
```{r, echo=FALSE, fig.cap='Gio with dynamic style'}
