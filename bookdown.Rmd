...
Let's add a pretty message, using the [cli](https://cli.r-lib.org/) [@R-cli] package, before we print the file as it allows introducing another concept; using external libraries in our package. To use cli we can run:
...
# A Complete Integration - jBox.js
