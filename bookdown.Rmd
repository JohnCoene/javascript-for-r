...
<!--chapter:end:3-27-htmlwidgets-polish.Rmd-->
...
Then it's a matter of reproducing the JSON that defines what plotly defines as a "trace" and what more or less corresponds to a "geom" in ggplot2. A trace for a scatter plot is defined with the JSON below, which we can read in R to understand the shape of the list to reproduce.
...
<!--chapter:end:3-28-htmlwidgets-plotly.Rmd-->
...
<!--chapter:end:4-15-shiny-cookies.Rmd-->
...
```r
#' @export
gio_send_data <- function(id, data, source, target, value, session = shiny::getDefaultReactiveDomain()){
  data <- dplyr::select(
    data,
    i = {{ source }},
    e = {{ target }},
...
<!--chapter:end:4-16-shiny-htmlwidgets.Rmd-->
