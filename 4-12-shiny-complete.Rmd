...
```{r, echo=FALSE, fig.cap='Shiny app skeleton'}
...
```{r, echo=FALSE, fig.cap='Results logged to the console'}
...
```{r, echo=FALSE, fig.cap='Classifier basic output'}
...
```{r, echo=FALSE, fig.cap='Classifier table output'}
