...
```{r shiny-complex-diagram, echo=FALSE, fig.cap='Simple shiny app, complex communication'}
d <- DiagrammeR::grViz("
digraph {
...
```{r shiny-complete-skeleton, echo=FALSE, fig.cap='Shiny app skeleton'}
...
```{r shiny-complete-classify-console, echo=FALSE, fig.cap='Results logged to the console'}
...
```{r shiny-complete-ml5-output, echo=FALSE, fig.cap='Classifier basic output'}
...
```{r shiny-complete-table-output, echo=FALSE, fig.cap='Classifier table output'}
