...
```{r shiny-complex-diagram, fig.pos="H", echo=FALSE, fig.cap='Simple shiny app, complex communication'}
d <- DiagrammeR::grViz("
digraph {
...
include_widget(d, "04-shiny-complex.png")
```
...
```{r shiny-complete-skeleton, fig.pos="H", echo=FALSE, fig.cap='Shiny app skeleton'}
knitr::include_graphics("images/shiny-complete-skeleton.png")
```
...
```{r shiny-complete-classify-console, fig.pos="H", echo=FALSE, fig.cap='Results logged to the console'}
knitr::include_graphics("images/shiny-complete-classify-console.png")
```
...
```{r shiny-complete-ml5-output, fig.pos="H", echo=FALSE, fig.cap='Classifier basic output'}
knitr::include_graphics("images/ml5-output.png")
```
...
```{r shiny-complete-table-output, fig.pos="H", echo=FALSE, fig.cap='Classifier table output'}
knitr::include_graphics("images/shiny-complete-table.png")
```
