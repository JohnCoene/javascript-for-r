...
In shiny, we would provide a dropdown menu to choose from pre-selected images and upon selection the selected image is displayed in the UI, the model runs and then sends the results to the R server which prints them in the UI.
...
digraph {
  ...
  subgraph cluster_0 {
    node [shape=box]
    select [label='selectInput()']
    img [label='<img>']
    res[label='model results']
