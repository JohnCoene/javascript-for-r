...
In this short section we hammer in what was covered in this chapter by creating another function that sends data directly to JavaScript, namely `setStyle` so one can change the style.
