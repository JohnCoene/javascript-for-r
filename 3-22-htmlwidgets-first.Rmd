...
```{r playground-1, echo=FALSE, fig.cap='First widget'}
...
```{r widget-internals-diagram, echo=FALSE, fig.cap='htmlwidgets internals visualised'}
d <- DiagrammeR::grViz("
digraph {
  graph [rankdir = LR]
...
```{r playground-console, echo=FALSE, fig.cap='Console log JavaScript object'}
...
```{r playground-console-el, echo=FALSE, fig.cap='Console log HTML element'}
...
```{r playground-h1, echo=FALSE, fig.cap='First widget output'}
...
```{r playground-tags, echo=FALSE, fig.cap='First widget using shiny tags'}
