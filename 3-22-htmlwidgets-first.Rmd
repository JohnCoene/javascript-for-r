...
```{r, echo=FALSE, fig.cap='First widget'}
...
```{r, echo=FALSE, fig.cap='Console tab output'}
...
```{r, echo=FALSE, fig.cap='Console tab output element'}
...
```{r, echo=FALSE, fig.cap='First widget output'}
...
```{r, echo=FALSE, fig.cap='First widget using shiny tags'}
