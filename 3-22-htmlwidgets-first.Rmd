...
```{r playground-1, fig.pos="H", echo=FALSE, fig.cap='First widget'}
knitr::include_graphics("images/playground-1.png")
```
...
```{r widget-internals-diagram, fig.pos="H", echo=FALSE, fig.cap='htmlwidgets internals visualised'}
d <- DiagrammeR::grViz("
digraph {
  graph [rankdir = LR]
...
include_widget(d, "03-htmlwidgets-internals.png")
```
...
```{r playground-console, fig.pos="H", echo=FALSE, fig.cap='Console log JavaScript object'}
knitr::include_graphics("images/playground-console-x.png")
```
...
```{r playground-console-el, fig.pos="H", echo=FALSE, fig.cap='Console log HTML element'}
knitr::include_graphics("images/playground-console-el.png")
```
...
```{r playground-h1, fig.pos="H", echo=FALSE, fig.cap='First widget output'}
knitr::include_graphics("images/playground-h1.png")
```
...
```{r playground-tags, fig.pos="H", echo=FALSE, fig.cap='First widget using Shiny tags'}
knitr::include_graphics("images/playground-color.png")
```
