...
```{r, echo=FALSE, fig.pos="H", out.width="100%", fig.dim=c(3, 6), fig.cap='Websocket visualised'}
d <- DiagrammeR::grViz("
digraph{
...
include_widget(d, "04-websocket.png")
```
...
```{r shiny-websocket-diagram, fig.pos="H", echo=FALSE, fig.align='center', out.width="100%", fig.dim=c(3, 6), fig.cap='Shiny websocket visualised'}
d <- DiagrammeR::grViz("
digraph {
...
include_widget(d, "04-shiny-websocket.png")
```
...
```{r jbox-init, fig.pos="H", echo=FALSE, fig.cap='A basic jBox notice'}
...
```{r jbox-r2js, fig.pos="H", echo=FALSE, fig.cap='A notice triggered by the server'}
...
```{r shiny-alert-diagram, fig.pos="H", echo=FALSE, fig.align='center', out.width="100%", fig.dim=c(3, 6), fig.cap='Shiny alert with custom messages'}
d <- DiagrammeR::grViz("
digraph{
  graph [rankdir=LR]
  node [shape=record fontsize=10];
...
include_widget(d, "04-custom-msg.png")
```
...
```{r jbox-custom, fig.pos="H", echo=FALSE, fig.cap='Customised jBox notice'}
...
```{r jbox-end, fig.pos="H", echo=FALSE, fig.cap='jBox final application'}
