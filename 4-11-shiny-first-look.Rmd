...
```{r, echo=FALSE, fig.align='center', out.width="100%", fig.dim=c(3, 6), fig.cap='Websocket visualised'}
d <- DiagrammeR::grViz("
digraph{
...
```{r shiny-websocket-diagram, echo=FALSE, fig.align='center', out.width="100%", fig.dim=c(3, 6), fig.cap='Shiny websocket visualised'}
d <- DiagrammeR::grViz("
digraph {
...
```{r jbox-init, echo=FALSE, fig.cap='A basic jBox notice'}
...
```{r jbox-r2js, echo=FALSE, fig.cap='[A notice triggered by the server'}
...
```{r shiny-alert-diagram, echo=FALSE, fig.align='center', out.width="100%", fig.dim=c(3, 6), fig.cap='Shiny alert with custom messages'}
d <- DiagrammeR::grViz("
digraph{
  graph [rankdir=LR]
  node [shape=record fontsize=10];
...
```{r jbox-custom, echo=FALSE, fig.cap='Customised jBox notice'}
...
```{r jbox-end, echo=FALSE, fig.cap='jBox final application'}
