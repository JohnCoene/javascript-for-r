...
```{r, echo=FALSE, fig.cap='Gio.js example'}
...
```{r, echo=FALSE, fig.cap='Gio output without data'}
...
```{r, echo=FALSE, fig.cap='Gio output with correct serialisation'}
...
```{r, echo=FALSE, fig.cap='Gio with a new theme'}
