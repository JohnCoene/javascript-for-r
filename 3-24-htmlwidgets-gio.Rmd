...
```{r gio-example, echo=FALSE, fig.cap='Gio.js example'}
...
```{r gio-init, echo=FALSE, fig.cap='Gio output without data'}
...
```{r gio-data, echo=FALSE, fig.cap='Gio output with correct serialisation'}
...
```{r gio-style, echo=FALSE, fig.cap='Gio with a new theme'}
